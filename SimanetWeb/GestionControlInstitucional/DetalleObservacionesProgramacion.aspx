...
<%@ Page language="c#" Codebehind="DetalleObservacionesProgramacion.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.DetalleObservacionesProgramacion" %>
				...
				<TR>
					<TD vAlign="top" align="center">
						<TABLE id="Table4" cellSpacing="0" cellPadding="0" border="0" width="100%" align="center">
							<TR>
								<TD class="Commands" style="WIDTH: 590px; HEIGHT: 11px" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >  Gestión de Control Institucional ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración Gestiones de Programación</asp:label></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD align="center"><SPAN class="normal"></SPAN>
									<TABLE class="normal" id="Table3" cellSpacing="0" cellPadding="0" align="center" border="1"
										width="550" borderColor="#ffffff">
										<TR>
											<TD class="TituloPrincipalBlanco" style="HEIGHT: 16px" vAlign="top" bgColor="#000080"
												colSpan="5"><asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipalBlanco"></asp:label><asp:label id="lblDatos" runat="server" CssClass="TituloPrincipalBlanco"></asp:label></TD>
											<TD class="normal" style="WIDTH: 298px; HEIGHT: 16px" colSpan="4"></TD>
											<TD class="normal" style="WIDTH: 27px; HEIGHT: 16px" colSpan="2"></TD>
										</TR>
										<TR>
											<TD class="normal" style="WIDTH: 75px; HEIGHT: 31px" bgColor="#335eb4"><asp:label id="lblFecha" runat="server" CssClass="TextoBlanco">Fecha:</asp:label></TD>
											<TD class="normal" style="WIDTH: 298px; HEIGHT: 31px" colSpan="4" bgColor="#dddddd">
											...
											<TD class="normal" style="WIDTH: 27px; HEIGHT: 31px" colSpan="2"></TD>
										</TR>
										<TR>
											<TD class="normal" style="WIDTH: 75px; HEIGHT: 42px" bgColor="#335eb4">
												<asp:label id="Label1" runat="server" CssClass="TextoBlanco">Gestión:</asp:label></TD>
											<TD class="normal" style="WIDTH: 298px; HEIGHT: 42px" colSpan="4" rowSpan="1" bgColor="#f0f0f0">
												<asp:textbox id="txtGestion" runat="server" CssClass="normaldetalle" Width="488px" MaxLength="200"
													Height="56px"></asp:textbox></TD>
											<TD class="normal" style="WIDTH: 27px; HEIGHT: 42px" colSpan="2"><cc1:requireddomvalidator id="rfvGestion" runat="server" ControlToValidate="txtGestion">*</cc1:requireddomvalidator></TD>
										</TR>
										<TR>
											<TD class="normal" style="WIDTH: 75px" bgColor="#335eb4"><asp:label id="lblConcepto" runat="server" CssClass="TextoBlanco" Width="94px"> Descripción:</asp:label></TD>
											<TD class="normal" style="WIDTH: 298px" colSpan="4" bgColor="#dddddd"><asp:textbox id="txtDescripcion" runat="server" CssClass="normaldetalle" Width="488px" MaxLength="1500"
													TextMode="MultiLine" Height="144px"></asp:textbox></TD>
											<TD class="normal"></TD>
										</TR>
									</TABLE>
									<TABLE id="Table7" border="0" align="center" width="650">
										<TR>
											<TD align="center">&nbsp;
