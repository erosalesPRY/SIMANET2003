...
{
	/// <summary>
	/// Summary description for PopupImpresionAreaCritica.
	/// </summary>
	public class PopupImpresionAreaCritica : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		const string GRILLAVACIA ="No existe ninguna Área Crítica.";
