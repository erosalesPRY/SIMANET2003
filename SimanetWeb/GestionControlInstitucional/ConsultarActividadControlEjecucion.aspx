...
<%@ Page language="c#" Codebehind="ConsultarActividadControlEjecucion.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.ConsultarActividadControlEjecucion" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="Commands">
						...
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual">Consulta de las Actividades de Control</asp:label></TD>
				</TR>
				<TR>
					<TD align="center">
