...
<%@ Page language="c#" Codebehind="DetalleControlInterno.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstituacional.DetalleControlInterno" %>
				...
				<TR>
					<TD vAlign="top" align="center">
						<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" align="center">
							<TR>
								<TD class="Commands" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >  Gestión de Control Institucional ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Registro Control de Auditoría</asp:label></TD>
							</TR>
						</TABLE>
				<TR>
					<TD vAlign="top" align="center"><SPAN class="normal"></SPAN>
						<TABLE class="normal" id="Table3" borderColor="#ffffff" cellSpacing="0" cellPadding="0"
							...
							<TR>
								...
								<TD class="normal" bgColor="#dddddd" colSpan="4"><ew:calendarpopup id="CalFechaDocumento" runat="server" CssClass="normaldetalle" Width="80px" ImageUrl="../imagenes/BtPU_Mas.gif"
							...
							<TR>
								<TD class="normal" bgColor="#335eb4">
									<asp:label id="Label8" runat="server" CssClass="TextoBlanco">Area:</asp:label></TD>
							...
							<TR>
								<TD class="normal" bgColor="#335eb4"><asp:label id="lblFecha" runat="server" CssClass="TextoBlanco">Tipo:</asp:label></TD>
								<TD class="normal" bgColor="#dddddd" colSpan="4"><asp:dropdownlist id="ddlbTipoDocumento" runat="server" CssClass="normaldetalle" Height="70px" Width="248px"></asp:dropdownlist></TD>
								<TD class="normal" colSpan="2"></TD>
							</TR>
							<TR>
								<TD class="normal" bgColor="#335eb4">
							...
							<TR>
								...
								<TD class="normal" bgColor="#f0f0f0" colSpan="4"><ew:calendarpopup id="calFechaInicio" runat="server" CssClass="normaldetalle" Width="80px" ImageUrl="../imagenes/BtPU_Mas.gif"
										PadSingleDigits="True" Culture="Spanish (Chile)" ControlDisplay="TextBoxImage" ShowGoToToday="True" ClearDateText="Limpiar Fecha" DisableTextboxEntry="False"
										NullableLabelText="Seleccione una fecha:" MonthYearPopupCancelText="Cancelar" MonthYearPopupApplyText="Aceptar" GoToTodayText="Hoy :" AllowArbitraryText="False">
										<TextboxLabelStyle CssClass="NormalDetalle"></TextboxLabelStyle>
										<WeekdayStyle Font-Size="XX-Small" Font-Names="Verdana,Helvetica,Tahoma,Arial" ForeColor="Black"
							...
							<TR>
								<TD class="normal" bgColor="#335eb4"><asp:label id="Label1" runat="server" CssClass="TextoBlanco"> Organismo:</asp:label></TD>
								<TD class="normal" bgColor="#dddddd" colSpan="4" rowSpan="1"><asp:textbox id="txtEntidad" runat="server" CssClass="normaldetalle" Width="480px" ReadOnly="True"></asp:textbox>
									<asp:image id="ibtnBuscar" runat="server" ImageUrl="../imagenes/BtPU_Mas.gif"></asp:image></TD>
								<TD class="normal" colSpan="2">
									<cc1:requireddomvalidator id="rfvOrganismo" runat="server" ControlToValidate="txtEntidad">*</cc1:requireddomvalidator></TD>
							</TR>
							<TR>
								<TD class="normal" bgColor="#335eb4">
								...
								<TD class="normal" colSpan="2"><cc1:requireddomvalidator id="rfvAsunto" runat="server" ControlToValidate="txtAsunto">*</cc1:requireddomvalidator></TD>
							</TR>
							<TR>
								<TD class="normal" bgColor="#335eb4"><asp:label id="Label3" runat="server" CssClass="TextoBlanco">Situación Actual:</asp:label></TD>
								<TD class="normal" bgColor="#f0f0f0" colSpan="4"><asp:textbox id="txtSituacionActual" runat="server" CssClass="normaldetalle" Height="50px" MaxLength="1500"
										Width="100%" TextMode="MultiLine"></asp:textbox></TD>
						...
						<TABLE id="Table7" width="630" align="center" border="0">
							<TR>
								<TD align="center"><SPAN class="normal"><INPUT id="hNumero" style="WIDTH: 9px; HEIGHT: 22px" type="hidden" size="1" name="hNumero"
											runat="server"><INPUT id="hIdTablaEntidad" style="WIDTH: 9px; HEIGHT: 22px" type="hidden" size="1" name="hIdTablaEntidad"
											runat="server"></SPAN><INPUT id="hIdCodigo" style="WIDTH: 14px; HEIGHT: 22px" type="hidden" size="1" name="hIdCodigo"
