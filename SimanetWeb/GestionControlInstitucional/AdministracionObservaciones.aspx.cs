...
namespace SIMA.SimaNetWeb.GestionControlInstitucional
{
	...
	/// </summary>
	public class AdministracionObservaciones: System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.ObservacionesControlTAD.ToString())>0)
