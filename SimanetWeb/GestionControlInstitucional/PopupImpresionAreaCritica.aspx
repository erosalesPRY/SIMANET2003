<%@ Page language="c#" Codebehind="PopupImpresionAreaCritica.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.PopupImpresionAreaCritica" %>
						...
						<TABLE class="normal" id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="7"
										...
										<Columns>
											<asp:BoundColumn DataField="NroGrupoAreaCritica" HeaderText="CODIGO">
												<HeaderStyle Width="15%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="GRUPO" HeaderText="GRUPO">
												<HeaderStyle Width="15%"></HeaderStyle>
