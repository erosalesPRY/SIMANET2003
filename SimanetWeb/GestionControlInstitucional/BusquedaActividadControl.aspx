<%@ Page language="c#" Codebehind="BusquedaActividadControl.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.BusquedaActividadControl" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
				...
				<TR>
					<TD align="center">
						<TABLE class="tabla" id="Table6" cellSpacing="0" cellPadding="0" width="550" bgColor="#f5f5f5"
							...
							<TR>
								<TD class="TitFiltros" align="left">&nbsp;<INPUT id="hIdActividadCtrl" style="WIDTH: 16px; HEIGHT: 22px" type="hidden" size="1" name="hIdActividadCtrl"
										runat="server"><INPUT id="hActividadCtrl" style="WIDTH: 16px; HEIGHT: 22px" type="hidden" size="1" name="hActividadCtrl"
										runat="server"></TD>
								<TD class="combos"></TD>
								<TD class="combos"><asp:label id="lblDescripcion" runat="server" CssClass="normal">Denominacion de la Actividad</asp:label></TD>
								<TD class="combos"></TD>
								<TD class="combos"></TD>
							</TR>
							<TR>
								...
								<TD class="combos"><cc2:requireddomvalidator id="rfvActividadCtrl" runat="server" CssClass="normal" ControlToValidate="txtDenominacion">*</cc2:requireddomvalidator></TD>
						...
						<TABLE class="normal" id="Table1" cellSpacing="0" cellPadding="0" width="550" border="0">
							<TR>
								<TD align="center" colSpan="3"><cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" Width="600px" AllowSorting="True"
										AutoGenerateColumns="False" AllowPaging="True" RowHighlightColor="#E0E0E0" RowPositionEnabled="False" DataKeyField="IdActividadCtrl">
										<AlternatingItemStyle CssClass="AlternateItemGrilla"></AlternatingItemStyle>
										<ItemStyle CssClass="ItemGrilla"></ItemStyle>
										<HeaderStyle CssClass="HeaderGrilla"></HeaderStyle>
										<FooterStyle CssClass="FooterGrilla"></FooterStyle>
										<Columns>
											<asp:BoundColumn Visible="False" DataField="IdActividadCtrl"></asp:BoundColumn>
											<asp:BoundColumn DataField="Denominacion" SortExpression="Denominacion" HeaderText="DENOMINACION DE LA ACTIVIDAD"></asp:BoundColumn>
										</Columns>
		...
		function PonerTexto()
			{ 
				opener.document.forms[0].hIdActividadCtrl.value =document.forms[0].hIdActividadCtrl.value;
				opener.document.forms[0].txtActividadCtrl.value =document.forms[0].hActividadCtrl.value;
				window.close();
			} 
		</script>
	</body>
