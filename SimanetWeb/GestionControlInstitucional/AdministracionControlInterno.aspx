...
<%@ Page language="c#" Codebehind="AdministracionControlInterno.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionControlInterno" %>
				...
				<tr>
					<td vAlign="top">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" style="HEIGHT: 23px" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >  Gestión de Control Institucional ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración Auditoría</asp:label></TD>
							</TR>
							<TR>
								<TD align="center">
											...
											<TD vAlign="top" align="center" colSpan="3">
												<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														...
														<TD bgColor="#f0f0f0"><asp:imagebutton id="ibtnEliminarFiltro" runat="server" ImageUrl="../imagenes/filtroEliminar.GIF"
																ToolTip="Eliminar Filtro.."></asp:imagebutton><IMG height="8" src="../imagenes/spacer.gif" width="205"></TD>
														...
														<TD bgColor="#f0f0f0"><asp:imagebutton id="ibtnObservaciones" runat="server" ImageUrl="../imagenes/btnObservaciones.jpg"></asp:imagebutton></TD>
														<TD bgColor="#f0f0f0">
															<asp:imagebutton id="ibtnAcciones" runat="server" ImageUrl="../imagenes/btnAccion.jpg"></asp:imagebutton></TD>
													</TR>
												</TABLE>
												<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" RowPositionEnabled="False" RowHighlightColor="#E0E0E0"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="FechaTermino" SortExpression="FechaTermino" HeaderText="FECHA FIN." DataFormatString="{0:dd-MM-yyyy}">
															<HeaderStyle Width="12%"></HeaderStyle>
														</asp:BoundColumn>
														<asp:TemplateColumn>
									...
									<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="780" align="center" bgColor="#f5f5f5"
										...
										<TR>
											...
											<TD class="combos" bgColor="#f5f5f5"><asp:textbox id="txtSituacion" runat="server" CssClass="normal" Width="725px" ReadOnly="True"
