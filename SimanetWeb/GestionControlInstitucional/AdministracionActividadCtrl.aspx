...
<%@ Page language="c#" Codebehind="AdministracionActividadCtrl.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionActividadCtrl" %>
						...
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración de Actividades de Control</asp:label></TD>
							</TR>
							<TR>
								<TD align="center" colSpan="3">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> ADMINISTRACION DE ACTIVIDADES DE CONTROL</asp:label></TD>
							</TR>
							<TR>
								<TD align="left">
