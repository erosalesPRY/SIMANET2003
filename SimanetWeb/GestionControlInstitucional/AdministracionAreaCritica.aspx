...
<%@ Page language="c#" Codebehind="AdministracionAreaCritica.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionAreaCritica" %>
						...
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración de Grupos de Áreas Críticas ></asp:label></TD>
							</TR>
							<TR>
								<TD align="left">
										...
										<TR>
											<TD align="center" width="780">
												...
												<cc1:datagridweb id="grid" runat="server" ShowFooter="True" PageSize="7" AllowPaging="True" AllowSorting="True"
													AutoGenerateColumns="False" RowHighlightColor="#E0E0E0" Width="780px" align="center" DataKeyField="IdAreaCritica"
													...
													<Columns>
														<asp:BoundColumn Visible="False" DataField="IdGrupoAreaCritica" SortExpression="IdGrupoAreaCritica"
															HeaderText="IdGrupoAreaCritica">
															<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
															<FooterStyle HorizontalAlign="Center"></FooterStyle>
														</asp:BoundColumn>
														<asp:BoundColumn Visible="False" DataField="IdAreaCritica" SortExpression="IdAreaCritica" HeaderText="IdAreaCritica"></asp:BoundColumn>
														<asp:BoundColumn HeaderText="NRO">
															<HeaderStyle Width="15px"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="NroAreaCritica" SortExpression="NroAreaCritica" HeaderText="CODIGO">
															<HeaderStyle Width="15px"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
														</asp:BoundColumn>
