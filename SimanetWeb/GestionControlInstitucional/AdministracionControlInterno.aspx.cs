...
namespace SIMA.SimaNetWeb.GestionControlInstitucional
{
	...
	public class AdministracionControlInterno : System.Web.UI.Page,IPaginaBase
	{
		...
		const string FECHATERMINI="Fecha Término";
		...
		private void eliminar()
		{
			...
			else
			{
...

				{
					...
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"OCI",this.ToString(),"Se eliminó el Documento Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
