...
namespace SIMA.SimaNetWeb.GestionControlInstitucional
{
	...
	/// </summary>
	public class ConsultarAccionControlPosteriorEjecucion : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		const string TITULO = "CONSULTA DE LA EJECUCIONES DE LAS ACCIONES DE CONTROL POSTERIOR";
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,Utilitario.Helper.MostrarDatosEnCajaTexto(CONTROLCAJATEXTOOBSERVACIONES,dr[Enumerados.ColumnasAccionCtrlPosteriorEjec.Observaciones.ToString()].ToString()));
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(dtOCI
					...
					,Utilitario.Constantes.SIGNOASTERISCO + Utilitario.Enumerados.ColumnasAccionCtrlPosteriorEjec.Estado.ToString()+ ";Estado"
					,Utilitario.Constantes.SIGNOASTERISCO + Utilitario.Enumerados.ColumnasAccionCtrlPosteriorEjec.Etapa.ToString()+ ";Etapa"
