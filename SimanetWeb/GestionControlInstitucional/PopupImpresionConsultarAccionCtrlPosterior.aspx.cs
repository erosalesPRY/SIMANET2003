...
{
	/// <summary>
	/// Summary description for PopupImpresionConsultarAccionCtrlPosterior.
	/// </summary>
	public class PopupImpresionConsultarAccionCtrlPosterior : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		const string GRILLAVACIA ="No existe ninguna Accion de Control Posterior.";
