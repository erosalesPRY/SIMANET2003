<%@ Page language="c#" Codebehind="AdministracionAccionesControl.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionAccionesControl" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onload="ObtenerHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				<TR>
					<TD class="Commands" style="HEIGHT: 8px" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >  Gestión de Control Institucional ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración Acciones de Observación</asp:label></TD>
				</TR>
			</TABLE>
			</TD></TR><tr>
				<td>
						...
						<TR>
							<TD vAlign="top" align="center" colSpan="3">
								<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
									...
									<TR>
										<TD bgColor="#f0f0f0"><IMG height="8" src="../imagenes/spacer.gif" width="600"></TD>
								...
								<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" ShowFooter="True" AllowPaging="True"
									...
									<Columns>
										...
										<asp:BoundColumn DataField="DescripcionAccion" SortExpression="DescripcionAccion" HeaderText="DESCRIPCION">
											<ItemStyle HorizontalAlign="Left"></ItemStyle>
										</asp:BoundColumn>
										<asp:BoundColumn DataField="ObservacionAccion" SortExpression="ObservacionAccion" HeaderText="OBSERVACION">
											<ItemStyle HorizontalAlign="Left"></ItemStyle>
