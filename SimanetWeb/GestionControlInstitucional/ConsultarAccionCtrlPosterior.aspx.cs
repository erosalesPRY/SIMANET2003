...
{
	/// <summary>
	/// Summary description for ConsultarAccionCtrlPosterior.
	/// </summary>
	public class ConsultarAccionCtrlPosterior : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		//Otros
		const string GRILLAVACIA ="No existe ningúna Acci{on de Control Posterior.";  
