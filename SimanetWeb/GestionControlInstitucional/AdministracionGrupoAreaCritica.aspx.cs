...
{
	/// <summary>
	/// Summary description for AdministracionGrupoAreaCritica.
	/// </summary>
	public class AdministracionGrupoAreaCritica : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		//Ordenamiento
		const string COLORDENAMIENTO = "IdGrupoAreaCritica Asc";
		...
		//Paginas
		const string URLDETALLE = "DetalleGrupoAreaCritica.aspx?";
		const string URLIMPRESION = "PopupImpresionGrupoAreaCritica.aspx";
		...
		//Otros
		const string GRILLAVACIA ="No existe ningún Grupo de Área Crítica.";  
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(grid.DataKeys[indice]),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.GrupoAreaCriticaTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Detalle Grupo Area Critica",this.ToString(),"Se eliminó el Detalle de Grupo de Área Crítica Nro. " + grid.DataKeys[indice].ToString() + ".", Enumerados.NivelesErrorLog.I.ToString()));
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				try
				{
					...
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Detalle Grupo de Área Crítica",this.ToString(),"Se consultó los Grupos de Áreas Críticas Asignados.",Enumerados.NivelesErrorLog.I.ToString()));
		...
		private DataTable ObtenerDatos()
		{
			...
			return oCGrupoAreaCritica.ListarGrupoAreaCritica();
		}
		...
		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			...
			if (dt!=null)
			{
				...
				oCImpresion.GuardarDataImprimirExportar(dt,Helper.ObtenerValorString(Enumerados.SeccionesArchivoConfiguracion.ConfiguracionesAplicativo.ToString(),Utilitario.Constantes.CODIGOTITULOREPORTEGRUPOAREACRITICA),columnaOrdenar,indicePagina);
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,
					Utilitario.Helper.MostrarDatosEnCajaTexto("hCodigo",dr[Enumerados.ColumnasGrupoAreaCritica.IdGrupoAreaCritica.ToString()].ToString()));
				...
				e.Item.Cells[1].Attributes.Add(Utilitario.Constantes.EVENTOCLICK, Utilitario.Constantes.HISTORIALADELANTE + 
					Helper.MostrarVentana(URLDETALLE, KEYQID + Utilitario.Constantes.SIGNOIGUAL + Convert.ToString(dr[Enumerados.ColumnasGrupoAreaCritica.IdGrupoAreaCritica.ToString()]) +  Utilitario.Constantes.SIGNOAMPERSON + 
		...
		{
			ltlMensaje.Text = Helper.ElaborarFiltro(this.ObtenerDatos(),"NroGrupoAreaCritica;CODIGO","Denominacion;DENOMINACION");
		}
