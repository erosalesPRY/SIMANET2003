...
namespace SIMA.SimaNetWeb.GestionControlInstitucional
{
	...
	/// </summary>
	public class AdministracionObservacionesProgramacion: System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLPRINCIPAL = "AdministracionProgramacionActividades.aspx";
		const string URLDETALLE = "DetalleObservacionesProgramacion.aspx?";
		const string URLIMPRESION = "PopupImpresionAdministracionDeObservacionesProgramacion.aspx";
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.ObservacionesProgramacionTAD.ToString())>0)
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!Page.IsPostBack)
			{
				try
				{
					...
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"OCI",this.ToString(),"Se consultó las Gestiones de Programación.",Enumerados.NivelesErrorLog.I.ToString()));
		...
		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			...
			DataTable dtGestiones =  oCObservacionesProgramacion.ConsultarGestionesProgramacion(Convert.ToInt32(Page.Request.QueryString[KEYQID]));
			...
			if(dtGestiones!=null)
			{
				...
				oCImpresion.GuardarDataImprimirExportar(dtGestiones,Helper.ObtenerValorString(Enumerados.SeccionesArchivoConfiguracion.ConfiguracionesAplicativo.ToString(),Utilitario.Constantes.CODIGOTITULOREPORTERETENCIONES),columnaOrdenar,indicePagina);
			}
			else
			{
		...
		{
			Page.Response.Redirect(URLDETALLE + KEYQID + Utilitario.Constantes.SIGNOIGUAL + 
				Convert.ToInt32(Page.Request.QueryString[KEYQID]) + Utilitario.Constantes.SIGNOAMPERSON + 
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,
					Utilitario.Helper.MostrarDatosEnCajaTexto("hCodigo",dr[Enumerados.ColumnasObservacionesProgramacion.IdGestion.ToString()].ToString()));
				...
				e.Item.Cells[0].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					...
					Convert.ToString(dr[Enumerados.ColumnasObservacionesProgramacion.IdGestion.ToString()])));
