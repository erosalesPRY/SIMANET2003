...
<%@ Page language="c#" Codebehind="AdministracionAccionCtrlPosterior.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionAccionCtrlPosterior" %>
						...
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración de Acciones de Control Posterior ></asp:label></TD>
							</TR>
							<TR>
								<TD align="center" colSpan="3">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> ADMINISTRACION DE ACCIONES DE CONTROL POSTERIOR</asp:label></TD>
							</TR>
							<TR>
								<TD align="left">
											...
											<TD align="center" width="780">
												<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="780" border="0">
													<TR>
														...
														<TD bgColor="#f0f0f0" align="center">
															<asp:imagebutton id="imgEliminar" runat="server" ImageUrl="../imagenes/bt_eliminar.gif"></asp:imagebutton></TD>
														<TD bgColor="#f0f0f0" align="center">
...
<HeaderStyle Font-Names="Arial" CssClass="HeaderGrilla">
</HeaderStyle>

<FooterStyle Font-Names="Arial" CssClass="FooterGrilla">
</FooterStyle>

<Columns>
<asp:BoundColumn Visible="False" DataField="IdAccionCtrlPosterior" SortExpression="IdAccionCtrlPosterior" HeaderText="IdAccionCtrlPosterior">
...
<PagerStyle Font-Names="Arial" HorizontalAlign="Center" CssClass="PagerGrilla" Mode="NumericPages">
</PagerStyle>
												</cc1:datagridweb>
												<P></P>
