<%@ Page language="c#" Codebehind="AdministracionGrupoAreaCritica.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionControlInstitucional.AdministracionGrupoAreaCritica" %>
										...
										<TR>
											<TD align="center" width="780">
												...
												<cc1:datagridweb id="grid" runat="server" ShowFooter="True" PageSize="7" AllowPaging="True" AllowSorting="True"
													AutoGenerateColumns="False" RowHighlightColor="#E0E0E0" Width="780px" align="center" DataKeyField="IdGrupoAreaCritica"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="NroGrupoAreaCritica" SortExpression="NroGrupoAreaCritica" HeaderText="CODIGO">
															<HeaderStyle Width="15px"></HeaderStyle>
															<ItemStyle HorizontalAlign="Center"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="Denominacion" SortExpression="Denominacion" HeaderText="DENOMINACI&#211;N">
															<HeaderStyle Width="735px"></HeaderStyle>
