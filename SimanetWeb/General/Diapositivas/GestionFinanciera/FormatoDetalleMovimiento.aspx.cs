...
//[FINuspNTADConsultarFormatoDetalleMovimiento] '2',29,1,'',2018,5
namespace SIMA.SimaNetWeb.General.Diapositivas.GestionFinanciera
{
	/// <summary>
	/// Summary description for FormatoDetalleMovimiento.
	/// </summary>
	public class FormatoDetalleMovimiento : System.Web.UI.Page,IPaginaBase
	{
		...
		public void LlenarGrilla()
		{
			...
			//DataTable dt = (new  CEstadosFinancierosDirectorio()).ListarFormatoAnualDetalleposConcepto(Utilitario.Helper.GestionFinanciera.Params.IdFormato,Utilitario.Helper.GestionFinanciera.Params.IdReporte,Utilitario.Helper.GestionFinanciera.Params.ListaConceptosIn, Utilitario.Helper.GestionFinanciera.Params.IdCentroOperativo ,Utilitario.Helper.GestionFinanciera.Params.Periodo,Utilitario.Helper.GestionFinanciera.Params.IdMes);
			/*object []Params={Utilitario.Helper.GestionFinanciera.Params.IdFormato
							,Utilitario.Helper.GestionFinanciera.Params.IdReporte
							,Utilitario.Helper.GestionFinanciera.Params.ListaConceptosIn
							,Utilitario.Helper.GestionFinanciera.Params.IdCentroOperativo 
							,Utilitario.Helper.GestionFinanciera.Params.Periodo
							,Utilitario.Helper.GestionFinanciera.Params.IdMes
							};*/
		...
		{
			// TODO:  Add FormatoDetalleMovimiento.LlenarGrillaOrdenamiento implementation
		}

		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			// TODO:  Add FormatoDetalleMovimiento.LlenarGrillaOrdenamientoPaginacion implementation
		}

		public void LlenarCombos()
		{
			// TODO:  Add FormatoDetalleMovimiento.LlenarCombos implementation
		}
		...
		{
			// TODO:  Add FormatoDetalleMovimiento.LlenarJScript implementation
		}

		public void RegistrarJScript()
		{
			// TODO:  Add FormatoDetalleMovimiento.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add FormatoDetalleMovimiento.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add FormatoDetalleMovimiento.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add FormatoDetalleMovimiento.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add FormatoDetalleMovimiento.ValidarFiltros implementation
			return false;
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			try
			{
				...
				else if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
				{
					...
					/*if(Convert.ToInt32(dr["Principal"].ToString())==1)
					{
						e.Item.Cells[0].Font.Bold=true;
						e.Item.Cells[0].Font.Size = FontUnit.Point(8);
						e.Item.Cells[0].Style.Add("BACKGROUND-COLOR","gainsboro");
					}*/
