...
<%@ Page language="c#" Codebehind="AdministrarFormatoDetalleMovimientoporPeriodo.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.General.Formato.AdministrarFormatoDetalleMovimientoporPeriodo" %>
...
<HTML>
	...
	.imgCirc { Z-INDEX: 1; POSITION: absolute; BACKGROUND-REPEAT: no-repeat; TOP: -2px; left-30: }
		...
		<SCRIPT>
			...
			var IdGrupoInterconexion =0;
			var IdFormatoConectado ="0";
			var IdReporteConectado ="0"
			...
			function AceptarAccion(){
				...
				var IdOP = jNet.get('hOpSelected').value;
				if(IdOP==1){
					...
					if(confirm("Desea procesar el mes " + arrMes[document.getElementById("hIdMes").value-1].toString() + " ahora?...")) {
							var TipoReq = Page.Request.Params[KEYQREQCTACTABLE];
							if((TipoReq=="1")||(TipoReq=="2")){
								__doPostBack('btnPrc',document.getElementById("hIdMes").value+";"+idxCell);
							} 
							else{
								var URLLinks = SIMA.Utilitario.Helper.General.ObtenerPathApp() + "/General/Formato/ProcesarFormatoInterConexion.aspx?";
								var Params= KEYQIDFORMATO + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + KEYQPARAMETROS.IDFORMATO
									+	SIMA.Utilitario.Constantes.General.Caracter.signoAmperson.toString() 
									+	KEYQIDREPORTE + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + KEYQPARAMETROS.IDREPORTE
									+	SIMA.Utilitario.Constantes.General.Caracter.signoAmperson.toString() 
									+   KEYQNOMBREFORMATO + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + Page.Request.Params[KEYQNOMBREFORMATO] 
									+	SIMA.Utilitario.Constantes.General.Caracter.signoAmperson.toString() 
									+	KEYQPERIODO  + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + KEYQPARAMETROS.PERIODO
									+	SIMA.Utilitario.Constantes.General.Caracter.signoAmperson.toString() 
									+	KEYQIDMES  + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + document.getElementById("hIdMes").value
									+	SIMA.Utilitario.Constantes.General.Caracter.signoAmperson.toString() 
									+	IDCENTROOPERATIVO  + SIMA.Utilitario.Constantes.General.Caracter.SignoIgual.toString() + KEYQPARAMETROS.IDCENTROOPERATIVO;

								//(new System.Ext.UI.WebControls.Windows()).Detalle('Formatos Notas y Anexos Vinculados',URLLinks+Params,this,400,240,function(){ alert('procesar');});
								(new SIMA.Utilitario.Helper.Response()).ShowDialogoModal(URLLinks+Params,this,600,440);
								//debera de preguntar si termino el proceso de calculo iniciado
								if(jSIMA.GetClientData(SIMA.Utilitario.Enumerados.TipoSaveClient.Local,'FmtPrc')=='SI'){
									__doPostBack('btnPrc',document.getElementById("hIdMes").value+";"+idxCell);
								}
							}
					} 
			...
			function DetalleContablePorItem(e){
				if(e.getAttribute("Cargado")!=undefined){
					...
					var DISPLAY = ((e.getAttribute("VISIBLE")=="TRUE")?"none":"block");
						...
						e.setAttribute("VISIBLE",((DISPLAY=="none")?"FALSE":"TRUE"));
					return;
				}
		...
		<SCRIPT>
				...
				if(FormEntreRubro==0){alert('Concepto no configura Cta o Nota contable'); return;}
					...
					with(SIMA.Utilitario.Constantes.General.Caracter){
						Parametros = KEYQIDFORMATO + SignoIgual + Page.Request.Params[KEYQIDFORMATO] 
									...
									+ signoAmperson 
									+ KEYQIDGRUPOFORMATOINTERCONEX + SignoIgual + IdGrupoInterconexion
									+ signoAmperson 
									+ KEYQIDFORMATOCONECTADO + SignoIgual + IdFormatoConectado
									+ signoAmperson 
									+ KEYQIDREPORTECONECTADO + SignoIgual + IdReporteConectado;
					...
					if(TipoReq=="1"){
						URLLoad = URLPAGINAFORMUALCONTABLE;
					} 
					else if(TipoReq=="2"){
						URLLoad = URLPAGINANOTACONTABLE;
					}
					else{
						vAncho=740;
						vAlto = 450;
						URLLoad = URLPAGINAFORMATOSDISPONIBLES;
					}					
			...
			function ObtenerIdRubro(id,ConfigCta,IdGrpInteconexion,IdFmtconexion,IdRptconexion){
				IdRubroSelect = id;
				FormEntreRubro = ConfigCta;
				IdGrupoInterconexion=IdGrpInteconexion;
				IdFormatoConectado = IdFmtconexion;
				IdReporteConectado = IdRptconexion;
			}
			...
			function Progresso(){
						Ext.MessageBox.show({msg: 'Procesando formatos finencieros, please wait...'
																					,progressText: 'Saving...'
																					,width:300
																					,wait:true
	...
	<body onkeypress="if((event.keyCode==SIMA.Utilitario.Constantes.General.KeyCode.KeyReturn)||(event.keyCode==SIMA.Utilitario.Constantes.General.KeyCode.keyTab)){return false;}"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" border="1" cellSpacing="0" cellPadding="0" width="100%" height="100%">
				<TR>
					<TD align="left">
						<TABLE style="Z-INDEX: 0" id="tblBuscarArchivo" border="0" cellSpacing="1" cellPadding="1"
							width="100%" align="left">
							<TR>
								<TD colSpan="3"></TD>
							</TR>
							<TR bgColor="gainsboro">
								<TD><asp:label id="Label2" runat="server" Width="168px" CssClass="TituloPrincipalBlanco" ForeColor="Navy">INDICADORES FINANCIEROS:</asp:label></TD>
								<TD width="100%"><INPUT style="WIDTH: 100%; HEIGHT: 17px" id="FDoc" class="normaldetalle" size="29" type="file"
										name="FDoc" runat="server"></TD>
								<TD></TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD height="100%" vAlign="top" align="left"><cc1:datagridweb id="grid" runat="server" Width="100%" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="ENERO">
									...
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nEnero" runat="server" CssClass="NumericBox" Width="104px"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="FEBRERO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nFebrero" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="MARZO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nMarzo" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="ABRIL">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nAbril" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="MAYO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nMayo" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="JUNIO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nJunio" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="JULIO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nJulio" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="AGOSTO">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nAgosto" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="SETIEMBRE">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nSetiembre" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="OCTUBRE">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nOctubre" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="NOVIEMBRE">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nNoviembre" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="DICIEMBRE">
									<HeaderStyle Width="4.3%"></HeaderStyle>
									<ItemTemplate>
										<ew:numericbox style="Z-INDEX: 0" id="nDiciembre" runat="server" Width="104px" CssClass="NumericBox"
											AutoFormatCurrency="True" DollarSign=" " DecimalPlaces="3" MaxLength="18" BorderStyle="None"
											BorderColor="Transparent" BackColor="Transparent" TextAlign="Right" PlacesBeforeDecimal="15"></ew:numericbox>
									</ItemTemplate>
								</asp:TemplateColumn>
				...
				<TR style="DISPLAY: none">
					<TD align="center">
						<TABLE id="tblAcciones" border="0" cellSpacing="2" cellPadding="1" width="300">
							...
							<TR>
								<TD class="BaseItemInGrid"><asp:radiobutton id="R1" runat="server" GroupName="OPMes" Text="Importar Saldos y Procesar Formato"></asp:radiobutton></TD>
							</TR>
							<TR>
								<TD class="BaseItemInGrid"><asp:radiobutton id="R2" runat="server" GroupName="OPMes" Text="Procesar formato"></asp:radiobutton></TD>
							</TR>
							<TR>
								<TD class="BaseItemInGrid"><asp:radiobutton id="R3" runat="server" GroupName="OPMes" Text="Imprimir resumen"></asp:radiobutton></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD style="HEIGHT: 20px" class="BaseItemInGrid"><asp:radiobutton style="Z-INDEX: 0" id="R6" runat="server" GroupName="OPMes" Text="Exportar a excel detallado"></asp:radiobutton></TD>
							</TR>
							<TR>
								<TD><INPUT style="WIDTH: 72px; HEIGHT: 22px" id="hOpSelected" value="0" size="6" type="hidden"
										runat="server"><INPUT id="hRunReportCenter" type="hidden" runat="server"></TD>
							</TR>
						</TABLE>
