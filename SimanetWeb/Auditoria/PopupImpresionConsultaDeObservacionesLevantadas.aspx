...
<%@ Page language="c#" Codebehind="PopupImpresionConsultaDeObservacionesLevantadas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.Auditoria.PopupImpresionConsultaDeObservacionesLevantadas" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3">
									<asp:datagrid id="grid" runat="server" AllowPaging="True" AutoGenerateColumns="False">
										...
										<Columns>
											<asp:BoundColumn DataField="IdAccionCorrectiva" SortExpression="IdProgramacionAuditoria" HeaderText="NRO">
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="Descripcion" SortExpression="Descripcion" HeaderText="ACCION CORRECTIVA">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="Observacion" HeaderText="OBSERVACION">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
