...
namespace SIMA.SimaNetWeb.Convenio
{
	...
	/// </summary>
	public class ConsultarPeriodoUnidadesApoyo : System.Web.UI.Page, IPaginaBase
	{
...
//				LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Covenio",this.ToString(),"Se consulto los Periodos de Unidades de Apoyo " + ddlbPeriodoInicial.SelectedValue + "Desde el: " + Utilitario.Constantes.SEPARADOR + "Hasta el: " + ddlbPeriodoFinal.SelectedValue,Enumerados.NivelesErrorLog.I.ToString()));
...
//			catch(Exception oException)
//			{
//				string var = oException.Message.ToString(); 
//				SIMAExcepcionIU oSIMAExcepcionIU = LogTransaccional.CrearSIMAExcepcionIU(CNetAccessControl.GetUserName(),this.GetType().Name,Enumerados.OrigenError.Presentacion.ToString(),Utilitario.Constantes.CODIGOERRORGENERICO,oException.Message);
//				Helper.ControlarErrorIU(this,oSIMAExcepcionIU.Mensaje);
//			}
//		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				string sUrl=Helper.MostrarVentana(URLCONSULTARORDENTRABAJOUNIDADAPOYO,KEYIDPERIODOUNIDADESAPOYO +
					Utilitario.Constantes.SIGNOIGUAL +
					Convert.ToString(dr[Enumerados.ColumnasPeriodoUnidadesApoyo.IdPeriodoUnidadesApoyo.ToString()]) + 
					Utilitario.Constantes.SIGNOAMPERSON + KEYQPERIODO + Utilitario.Constantes.SIGNOIGUAL + 
					Convert.ToString(dr[Enumerados.ColumnasPeriodoUnidadesApoyo.Periodo.ToString()]) + Utilitario.Constantes.SIGNOPUNTOYCOMA +
