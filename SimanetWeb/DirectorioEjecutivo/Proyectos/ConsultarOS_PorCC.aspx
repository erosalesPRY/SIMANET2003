<%@ Page language="c#" Codebehind="ConsultarOS_PorCC.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Proyectos.ConsultarOS_PorCC" %>
	...
	<body onkeydown="if (event.keyCode==13 || event.keyCode==9)return false" onunload="SubirHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			<table border="0" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<TR>
					<TD class="RutaPaginaActual" vAlign="top" width="100%"><asp:label style="Z-INDEX: 0" id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Logística ></asp:label><asp:label style="Z-INDEX: 0" id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Consultar Ordenes de Servicio Por Centro de Costo</asp:label></TD>
				</TR>
				<TR>
						...
						<TABLE id="Table1" class="normal" border="0" cellSpacing="0" cellPadding="0" width="100%"
							...
							<TR>
								<TD width="100%" colSpan="3" align="center">
											...
											<TD>
												<TABLE style="Z-INDEX: 0" id="Table9" border="0" cellSpacing="0" cellPadding="0" width="100%">
													...
													<TR>
														...
														<TD><asp:label style="Z-INDEX: 0" id="Label8" runat="server" CssClass="normaldetalle" Font-Bold="True"
																Width="51px"> Buscar :</asp:label><INPUT style="Z-INDEX: 0; BORDER-BOTTOM: #999999 1px groove; BORDER-LEFT: #999999 1px groove; WIDTH: 172px; BORDER-TOP: #999999 1px groove; BORDER-RIGHT: #999999 1px groove"
									...
									<cc1:datagridweb id="grid" runat="server" Width="100%" AllowSorting="True" AutoGenerateColumns="False"
										RowHighlightColor="#E0E0E0" ShowFooter="True" PageSize="15">
...
<asp:BoundColumn DataField="DES_SER" SortExpression="DES_SER" HeaderText="RECURSO">
...
<asp:BoundColumn Visible="False" HeaderText="DIM. LARGO">
...
<asp:BoundColumn Visible="False" HeaderText="DIM. ANCHO">
<ItemStyle HorizontalAlign="Left">
</ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="NRO_OSE" SortExpression="NRO_OSE" HeaderText="O/C">
<HeaderStyle Width="5%">
</HeaderStyle>
...
<asp:BoundColumn DataField="EST_OSE" SortExpression="EST_OSE" HeaderText="ESTADO">
<HeaderStyle Width="3%">
</HeaderStyle>
...
<asp:BoundColumn DataField="FEC_EMS" SortExpression="FEC_EMS" HeaderText="FECHA O/S" DataFormatString="{0:dd-MM-yyyy}">
<HeaderStyle Width="5%">
</HeaderStyle>
...
<asp:BoundColumn DataField="TOT_OSE" SortExpression="TOT_OSE" HeaderText="IMPORTE TOTAL">
<HeaderStyle Width="7%">
</HeaderStyle>
...
<asp:BoundColumn DataField="TOT_OSE_SOLES" SortExpression="TOT_OSE_SOLES" HeaderText="IMPORTE TOTAL S/.">
<HeaderStyle Width="7%">
</HeaderStyle>
...
<asp:BoundColumn DataField="CNT_RCP_OSE" SortExpression="CNT_RCP_OSE" HeaderText="CANT. RECEPC.">
<HeaderStyle Width="5%">
</HeaderStyle>
...
<asp:BoundColumn DataField="CNT_ATE" SortExpression="CNT_ATE" HeaderText="CANT. ATEND.">
<HeaderStyle Width="5%">
</HeaderStyle>
