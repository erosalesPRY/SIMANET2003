<%@ Page language="c#" Codebehind="ConsultarOS_PorOT.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Proyectos.ConsultarOS_PorOT" %>
	...
	<body onkeydown="if (event.keyCode==13 || event.keyCode==9)return false" onunload="SubirHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			<table border="0" cellSpacing="0" cellPadding="0" width="100%" align="center">
				...
				<TR>
					<TD class="RutaPaginaActual" vAlign="top" width="100%"><asp:label style="Z-INDEX: 0" id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Proyectos ></asp:label><asp:label style="Z-INDEX: 0" id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Consultar Ordenes de Servicio Por OT</asp:label></TD>
				</TR>
				<TR>
...
<asp:BoundColumn DataField="CNT_UDO_OT" SortExpression="CNT_UDO_OT" HeaderText="CANT. UTILIZADA">
...
<asp:BoundColumn DataField="NRO_OSE" SortExpression="NRO_OSE" HeaderText="O/S">
<ItemStyle HorizontalAlign="Left">
</ItemStyle>
</asp:BoundColumn>
...
<asp:BoundColumn DataField="CNT_CMP_OTS" SortExpression="CNT_CMP_OTS" HeaderText="CANT. COMPRADA OT">
<ItemStyle HorizontalAlign="Left">
</ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="CNT_CMP_OSE" SortExpression="CNT_CMP_OSE" HeaderText="CANT. COMPRADA">
<ItemStyle HorizontalAlign="Right">
</ItemStyle>
...
<asp:BoundColumn DataField="CNT_RCP_OSE" SortExpression="CNT_RCP_OSE" HeaderText="CANT. RECEPCIONADA">
<ItemStyle HorizontalAlign="Right">
</ItemStyle>
