...
{
	public class ConsultarOC_PorCC : System.Web.UI.Page,IPaginaBase
	{
		#region Constantes
		...
		private DataTable ObtenerDatos()
		{
			...
			DataTable dtGeneral =oCResumenOCompraOServicio.ConsultarOrdenesCompra_PorCC(Page.Request.Params[KEYIDCENTRO].ToString());
			return dtGeneral;
		}
		private void Totaliza(DataView dv)
		{
			...
			arrTotaliza.Add((object)dv.Table.Compute("SUM(TOT_OCO_SOLES)",dv.RowFilter.ToString()));
