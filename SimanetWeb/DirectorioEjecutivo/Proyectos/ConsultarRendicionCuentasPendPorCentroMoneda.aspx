...
<%@ Page language="c#" Codebehind="ConsultarRendicionCuentasPendPorCentroMoneda.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Proyectos.ConsultarRendicionCuentasPendPorCentroMoneda" %>
								...
								<TD width="100%" colSpan="3" align="center">
									...
									<cc1:datagridweb id="grid" runat="server" PageSize="7" ShowFooter="True" Width="100%" RowHighlightColor="#E0E0E0"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="nombre" SortExpression="nombre" HeaderText="APELLIDOS Y NOMBRES">
