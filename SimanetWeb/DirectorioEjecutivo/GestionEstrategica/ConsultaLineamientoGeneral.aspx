<%@ Page language="c#" Codebehind="ConsultaLineamientoGeneral.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.GestionEstrategica.ConsultaLineamientoGeneral" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" rightMargin="0"
		...
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD colSpan="3">
						<uc2:menu id="Menu1" runat="server"></uc2:menu></TD>
				</TR>
				<TR>
					<TD>
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" style="HEIGHT: 3px" colSpan="3">
									<asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Proceso Estrategico ></asp:label>
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual">LINEAMIENTO GENERAL</asp:label></TD>
							</TR>
							<TR>
								<TD colSpan="3">
							...
							<TR>
								<TD colSpan="3">
									<P align="center">
										<asp:Label id="Label1" runat="server" CssClass="TituloPrincipalAzul">LINEAMIENTO GENERAL</asp:Label></P>
								</TD>
							</TR>
							<TR>
								<TD colSpan="3">
									<asp:Image id="Image1" runat="server" ImageUrl="../../imagenes/spacer.gif" Width="48px" Height="24px"></asp:Image></TD>
							</TR>
							<TR>
											...
											<TD align="center" width="100%" colSpan="3">
												<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="780" border="0">
													<TR>
														...
														<TD style="WIDTH: 66px" bgColor="#f0f0f0">
												...
												<cc1:datagridweb id="grid" runat="server" CssClass="HEaderGrilla" Width="780px" ShowFooter="True"
													...
													<Columns>
														...
														<asp:BoundColumn Visible="False" DataField="IDLINEAMIENTOGENERAL" SortExpression="IDLINEAMIENTOGENERAL"
															HeaderText="IDLINEAMIENTOGENERAL">
