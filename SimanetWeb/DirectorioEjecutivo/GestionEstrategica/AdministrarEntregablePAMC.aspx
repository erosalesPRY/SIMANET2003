...
<%@ Page language="c#" Codebehind="AdministrarEntregablePAMC.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.GestionEstrategica.AdministrarEntregablePAMC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AdministrarEntregablePAMC</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="commands" align="left">
						...
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> ADMINISTRAR ENTREGABLES</asp:label></TD>
				</TR>
				<TR>
					<TD align="center">
