<%@ Page language="c#" Codebehind="AdministrarConsultoresPAMC.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.GestionEstrategica.AdministrarConsultoresPAMC" %>
...
<HTML>
	<HEAD>
		<title>AdministrarConsultoresPAMC</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="commands" align="left">
						<asp:label id="lblRutaPagina" runat="server" CssClass="RutaPaginaActual">Inicio > Gestión Estrátegica >  Proyectos Apoyo a la Mejora de la Competitividad > Nivel > Componente  > Proyecto > T.D.R > </asp:label>
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> ADM. CONSULTORES</asp:label></TD>
				</TR>
				<TR>
					<TD align="center">
						<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"></asp:label><BR>
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="780" border="0">
							<TR>
								...
								<TD align="right" bgColor="#f0f0f0">
									<asp:imagebutton id="btnEntregables" runat="server" ImageUrl="../../imagenes/btnEntregables.gif"></asp:imagebutton>
								...
								<TD align="center" bgColor="#f0f0f0" colSpan="2">
									<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" Width="780px" AllowSorting="True"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NombreCorto" SortExpression="NombreCorto" HeaderText="CONSULTOR">
												<HeaderStyle Width="75%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
											</asp:BoundColumn>
											<asp:TemplateColumn HeaderText="CURRICULUM">
