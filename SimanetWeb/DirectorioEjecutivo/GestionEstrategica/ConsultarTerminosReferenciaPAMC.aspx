<%@ Page language="c#" Codebehind="ConsultarTerminosReferenciaPAMC.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.GestionEstrategica.ConsultarTerminosReferenciaPAMC" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" rightMargin="0"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="commands" align="left"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPaginaActual">Inicio > Gestión Estrátegica >  Proyectos Apoyo a la Mejora de la Competitividad > Convenio > Componente > Proyecto ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> T.D.R.</asp:label></TD>
				</TR>
				<TR>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="780" border="0">
							<TR>
								...
								<TD align="right" bgColor="#f0f0f0">
									<asp:imagebutton id="btnActividad" runat="server" ImageUrl="../../imagenes/btnActividad.gif"></asp:imagebutton></TD>
							</TR>
							<TR>
								<TD align="center" bgColor="#f0f0f0" colSpan="3">
									<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" Width="780px" AllowSorting="True"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NOMBRELARGO" SortExpression="NOMBRELARGO" HeaderText="T&#233;rmino de Referencia">
							...
							<TR>
								<TD colSpan="3" style="HEIGHT: 167px">
									<TABLE id="tblActividades" borderColor="#ff3300" cellSpacing="1" cellPadding="1" width="100%"
										border="0" runat="server">
										<TR>
											<TD align="center">
												<asp:label id="lblTituloActividad" runat="server" CssClass="TituloPrincipal">ACTIVIDADES</asp:label></TD>
										</TR>
										<TR>
											<TD align="center" bgColor="#f0f0f0">
												<cc1:datagridweb id="gridActividades" runat="server" CssClass="HeaderGrilla" Width="780px" AllowSorting="True"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="nombre" SortExpression="nombre" HeaderText="ACTIVIDADES">
												...
												<asp:label id="ltlResultadoActividad" runat="server" CssClass="ResultadoBusqueda">No exiten Registros</asp:label></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							<TR>
								<TD colSpan="3"><IMG id="ibtnAtras" style="CURSOR: hand" onclick="HistorialIrAtras();" alt="" src="../../imagenes/atras.gif"><INPUT id="hCodigo" style="WIDTH: 40px; HEIGHT: 22px" type="hidden" size="1" name="Hidden3"
