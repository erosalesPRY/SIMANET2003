...
<%@ Page language="c#" Codebehind="ConsultaConsultorPAMC.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.GestionEstrategica.ConsultaConsultorPAMC" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="commands" align="left">
						...
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> CONSULTOR</asp:label></TD>
				</TR>
				<TR>
					<TD align="center">
