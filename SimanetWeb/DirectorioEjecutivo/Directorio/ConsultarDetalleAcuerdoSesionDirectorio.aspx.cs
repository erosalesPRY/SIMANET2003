...
namespace SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio
{
	...
	/// </summary>
	public class ConsultarDetalleAcuerdoSesionDirectorio: System.Web.UI.Page, IPaginaBase
	{
		...
		protected System.Web.UI.WebControls.TextBox txtFechaAcuerdo;
		protected System.Web.UI.WebControls.Label Label2;
		protected System.Web.UI.WebControls.TextBox txtAcuerdo;
		protected System.Web.UI.HtmlControls.HtmlImage ibtnVer;
		#endregion Controles
		/// <summary>
		...
		public void CargarModoConsulta()
		{
			...
			{
				txtNroAcuerdo.Text = oAcuerdoSesionDirectorioBE.NroAcuerdoSesionDirectorio.ToString();
				txtTema.Text = oAcuerdoSesionDirectorioBE.Tema.ToString().ToUpper();
				txtSituacion.Text = oAcuerdoSesionDirectorioBE.Situacion.ToString().ToUpper();
				txtAcuerdo.Text = oAcuerdoSesionDirectorioBE.Acuerdo.ToString().ToUpper();
				if(!oAcuerdoSesionDirectorioBE.FechaAcuerdo.IsNull)
				{
					txtFechaAcuerdo.Text = Convert.ToDateTime(oAcuerdoSesionDirectorioBE.FechaAcuerdo).ToString(Utilitario.Constantes.FORMATOFECHA4);
				}			

				ibtnVer.Visible=false;
				/*if (oAcuerdoSesionDirectorioBE.Documento.ToString() != String.Empty)
				{
					ibtnVer.Visible=true;
					//ibtnVer.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,Helper.PopupMostrarArchivos(oAcuerdoSesionDirectorioBE.Documento.ToString()));
					ibtnVer.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,Helper.PopupMostrarArchivos(
						Helper.ObtenerRutaImagenes(Utilitario.Constantes.RUTASERVERDOCUMENTOSDIRECTORIO) + 
						oAcuerdoSesionDirectorioBE.Documento.ToString()));
				}
				else
				{
					ibtnVer.Visible=false;
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[0].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					Helper.MostrarVentaModalTextoHTML("GESTION",Convert.ToString(dr[Enumerados.ColumnasGestionesDirectorio.DescripcionGestion.ToString()]),500,400,0,400));
				e.Item.Cells[0].Text = Helper.ObtenerIndicedeRegistro(grid.CurrentPageIndex,grid.PageSize,e.Item.ItemIndex);
				e.Item.Cells[0].Font.Underline=true;
				e.Item.Cells[0].ForeColor= System.Drawing.Color.Blue;

				e.Item.Cells[2].Text = Convert.ToString(dr[Enumerados.ColumnasGestionesDirectorio.Gestion.ToString()]).ToUpper();
		...
		private void ddlbTipoProceso_SelectedIndexChanged(object sender, System.EventArgs e)
		{
		...
		private void txtTema_TextChanged(object sender, System.EventArgs e)
		{
