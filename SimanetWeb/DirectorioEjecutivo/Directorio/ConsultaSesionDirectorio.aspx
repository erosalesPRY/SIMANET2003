...
<%@ Page language="c#" Codebehind="ConsultaSesionDirectorio.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio.ConsultaSesionDirectorio" %>
...
<HTML>
  <HEAD>
		...
		<script>
			function AppRedirect(PathAppWebRedirect)
			{
				window.open(PathAppWebRedirect);
				closeApp();
			}
			function closeApp() 
			{
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" rightMargin="0"
		...
		<form id="Form1" onkeydown="return verificarBackspace()" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD class="Commands" vAlign="top"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >Gestión de la Dirección ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Bitácora de Sesiones</asp:label></TD>
				</TR>
				<tr>
											...
											<TD align="center" colSpan="3">
												<table cellSpacing="0" cellPadding="0" border="0" width="100%">
													<tr>
														...
														<td bgColor="#f0f0f0">&nbsp;<IMG height="8" src="../../imagenes/spacer.gif" width=640></td>
													</tr>
												</table>
...
<ItemTemplate>
<asp:Image id=imgFlag runat="server" ImageUrl="../../imagenes/ibtnSesionActiva.jpg" Height="18px"></asp:Image>
</ItemTemplate>
</asp:TemplateColumn>
</Columns>
