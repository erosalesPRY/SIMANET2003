...
<%@ Page language="c#" Codebehind="PopupImpresionAdministracionPedidoSesionDirectorio.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio.PopupImpresionAdministracionPedidoSesionDirectorio" %>
							...
							<TR>
								<TD class="xsolid" align="center">
									<cc1:datagridweb id="grid" runat="server" Width="689px" AutoGenerateColumns="False" AllowPaging="True"
										DataKeyField="IdPedidoSesionDirectorio" PageSize="7">
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="IdSesionDirectorio" SortExpression="IdSesionDirectorio"
												HeaderText="IdPedidoDirectorio"></asp:BoundColumn>
											<asp:BoundColumn DataField="NroPedidoSesionDirectorio" SortExpression="NroPedidoSesionDirectorio"
