<%@ Page language="c#" Codebehind="ConsultarAdquisicionesPropias.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio.ConsultarAdquisicionesPropias" %>
						...
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" style="HEIGHT: 12px" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Registro Adquisiciones Propias</asp:label></TD>
							</TR>
							<TR>
							</TR>
							<TR>
											...
											<TD vAlign="top" align="center" colSpan="3">
												<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
													<TR>
														...
														<TD bgColor="#f0f0f0" width="100%"><IMG style="Z-INDEX: 0" src="../../imagenes/spacer.gif" width="500" height="8"></TD>
														<TD bgColor="#f0f0f0">&nbsp;
												...
												<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" AutoGenerateColumns="False" ShowFooter="True"
													Width="100%" AllowSorting="True" AllowPaging="True" RowHighlightColor="#E0E0E0" RowPositionEnabled="False"
													PageSize="12">
...
<asp:BoundColumn DataField="Licitaciones" SortExpression="Licitaciones" HeaderText="LICITAC.">
<HeaderStyle Width="1%">
</HeaderStyle>
...
<asp:BoundColumn DataField="ConcursoPublico" SortExpression="ConcursoPublico" HeaderText="CONC&lt;br&gt;.PUBL.">
<HeaderStyle Width="5%">
</HeaderStyle>
...
<PagerStyle CssClass="PagerGrilla" Mode="NumericPages">
												...
												<asp:label id="lblResultado" runat="server" CssClass="ResultadoBusqueda" Height="7px" Width="56px"></asp:label></TD>
										</TR>
										<TR>
