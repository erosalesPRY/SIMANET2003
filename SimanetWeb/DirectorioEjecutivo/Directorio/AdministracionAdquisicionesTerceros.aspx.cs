...
namespace SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio
{
	...
	/// </summary>
	public class AdministracionAdquisicionesTerceros: System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLDETALLE = "DetalleAdquisicionesTerceros.aspx?";
		const string URLIMPRESION = "PopupImpresionAdministracionAdquisicionesTerceros.aspx";				
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.AdquisicionesTAD.ToString())>0)
		...
		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			...
			if(dtAdquisiciones!=null)
			{
				...
				string Filtro= Utilitario.Helper.ObtenerFiltro();
				dwAdquisiciones.RowFilter    = Filtro;
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[5].Text = Convert.ToDouble(dr[Enumerados.ColumnasAdquisiciones.MontoAdquisicion.ToString()]).ToString(Utilitario.Constantes.FORMATODECIMAL4) ;
			}	
		}
		...
		DataTable ObtenerDatos(){
			...
			return (new CAdquisiciones()).ConsultaAdquisiciones(TODOS,ObtenerFechaLogistica(Fecha));
		}
