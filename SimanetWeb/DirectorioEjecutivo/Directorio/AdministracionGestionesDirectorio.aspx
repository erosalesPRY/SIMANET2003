...
<%@ Page language="c#" Codebehind="AdministracionGestionesDirectorio.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.Legal.AdministracionGestionesDirectorio" %>
						...
						<TR>
							<TD vAlign="top">
								<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
									<TR>
										<TD class="Commands" style="HEIGHT: 8px" colSpan="3">
											<asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Legal></asp:label>
											<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración Gestiones de Directorio</asp:label></TD>
									</TR>
								</TABLE>
									...
									<TR>
										<TD vAlign="top" align="center" colSpan="3">
											<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="777" border="0">
												<TR>
													<TD colspan="8" class="TituloPrincipal" align="center">
														<asp:label id="lblSubTitulo" runat="server" CssClass="TituloPrincipal"></asp:label>
														<asp:label id="lblNroAcuerdo" runat="server" CssClass="TituloSecundario"></asp:label>
													</TD>
												</TR>
												<TR>
													...
													<TD bgColor="#f0f0f0"><IMG height="8" src="../../imagenes/spacer.gif" width="340"><IMG height="8" src="../imagenes/spacer.gif" width="0"></TD>
													...
													<TD align="right" width="7" bgColor="#f0f0f0"><IMG id="ibtnSesiones" title="Bitácora de Sesiones" style="CURSOR: hand" alt="" src="../../imagenes/nota.gif"
															runat="server"></TD>
												</TR>
												<TR>
													<TD colSpan="9" style="WIDTH: 784px">
														<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" ShowFooter="True" AllowPaging="True"
															AllowSorting="True" AutoGenerateColumns="False" RowHighlightColor="#E0E0E0" Width="100%" PageSize="5">
