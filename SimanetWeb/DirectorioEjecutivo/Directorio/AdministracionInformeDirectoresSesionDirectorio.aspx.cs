...
namespace SIMA.SimaNetWeb.DirectorioEjecutivo.Directorio
{
	...
	/// </summary>
	public class AdministracionInformeDirectoresSesionDirectorio : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		const string TITULOIMPRESION = "REPORTE DE INFORMES DE DIRECTORES";
		...
		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar,int indicePagina)
		{
			...
			if(dtInformeDirectoresSesionDirectorio!=null)
			{
				...
				oCImpresion.GuardarDataImprimirExportar(dtInformeDirectoresSesionDirectorio,Helper.ObtenerValorString(Enumerados.SeccionesArchivoConfiguracion.ConfiguracionesAplicativo.ToString(),Utilitario.Constantes.CODIGOTITULOREPORTEINFORMEDIRECTORES),columnaOrdenar,indicePagina);
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[0].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					...
					Convert.ToString(dr[Enumerados.ColumnasInformeDirectoresSesionDirectorio.IdInformeDirectoresSesionDirec.ToString()]) +  
