...
<%@ Page language="c#" Codebehind="PopupImpresionConsultarDetalleMontoClientePorCOyLN.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Cliente.PopupImpresionConsultarDetalleMontoClientePorCOyLN" %>
				...
				<TR>
					<TD align="center">
						<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" RowPositionEnabled="False" RowHighlightColor="#E0E0E0"
							Width="650px" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" ShowFooter="True" AllowSorting="True">
