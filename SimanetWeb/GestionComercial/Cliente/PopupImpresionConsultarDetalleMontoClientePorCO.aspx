...
<%@ Page language="c#" Codebehind="PopupImpresionConsultarDetalleMontoClientePorCO.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Cliente.PopupImpresionConsultarDetalleMontoClientePorCO" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3">
									<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" RowPositionEnabled="False" RowHighlightColor="#E0E0E0"
										DESIGNTIMEDRAGDROP="68" ShowFooter="True">
