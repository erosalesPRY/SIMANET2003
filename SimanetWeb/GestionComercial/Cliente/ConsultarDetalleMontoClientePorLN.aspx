<%@ Page language="c#" Codebehind="ConsultarDetalleMontoClientePorLN.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Cliente.ConsultarDetalleMontoClientePorLN" %>
...
<HTML>
	<HEAD>
		<title>ConsultarDetalleMontoClientePorLN</title>
			...
			<TABLE id="Table3" style="HEIGHT: 438px" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<TR>
					<TD class="Commands" colSpan="3">&nbsp;
						<asp:label id="lblRuta_Pagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Comercial > Clientes > </asp:label><asp:label id="lblPage" runat="server"> Consulta Detalle de Ventas Por Cliente Por Linea de Negocio</asp:label></TD>
				</TR>
				<TR>
					<TD class="TituloPrincipal" align="center" colSpan="3"><asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal">DETALLE DE VENTAS POR CLIENTE POR LINEA DE NEGOCIO</asp:label></TD>
				</TR>
				<TR>
					<TD align="center">
					...
					<TD align="center">
						<TABLE class="tabla" id="Table2" cellSpacing="0" cellPadding="0" width="650" bgColor="#f5f5f5"
							...
							<TR>
								...
								<TD class="SmallFont" width="169"><asp:label id="lblFechaInicio" runat="server" CssClass="normal">Fecha de Inicio</asp:label>
									<ew:calendarpopup id="CalFechaInicio" runat="server" CssClass="normaldetalle" PadSingleDigits="True"
										Culture="Spanish (Chile)" ControlDisplay="TextBoxImage" ShowGoToToday="True" AllowArbitraryText="False"
										Width="72px" ImageUrl="../../imagenes/BtPU_Mas.gif" MonthYearPopupCancelText="Cancelar" MonthYearPopupApplyText="Aceptar"
										GoToTodayText="Hoy :" NullableLabelText="Seleccione una fecha:">
								...
								<TD class="SmallFont"><asp:label id="lblFechaFin" runat="server" CssClass="normal">Fecha de Fin</asp:label>
									<ew:calendarpopup id="CalFechaFin" runat="server" CssClass="normaldetalle" PadSingleDigits="True"
										Culture="Spanish (Chile)" ControlDisplay="TextBoxImage" ShowGoToToday="True" AllowArbitraryText="False"
										Width="72px" ImageUrl="../../imagenes/BtPU_Mas.gif" MonthYearPopupCancelText="Cancelar" MonthYearPopupApplyText="Aceptar"
										GoToTodayText="Hoy :" NullableLabelText="Seleccione una fecha:">
										<TextboxLabelStyle CssClass="NormalDetalle"></TextboxLabelStyle>
						...
						<TABLE class="normal" id="Table1" cellSpacing="0" cellPadding="0" width="650" border="0">
							...
							<TR>
								<TD align="center" width="100%" colSpan="3">
									<DIV>
										<DIV style="OVERFLOW: auto; WIDTH: 650px; HEIGHT: 125px" align="center">
											<cc1:datagridweb id="dgConsulta" runat="server" CssClass="HeaderGrilla" DESIGNTIMEDRAGDROP="68" RowPositionEnabled="False"
							...
							<TR>
								<TD style="HEIGHT: 11px" align="center" width="100%" colSpan="3"><asp:label id="lblResultado" runat="server" CssClass="ResultadoBusqueda" Visible="False"></asp:label></TD>
							</TR>
							<TR>
