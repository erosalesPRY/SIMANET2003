...
{
	/// <summary>
	/// Summary description for PopupImpresionConsultarDetalleMontoClientePorCO.
	/// </summary>
	public class PopupImpresionConsultarDetalleMontoClientePorCO : System.Web.UI.Page
	{
		#region Controles
		...
		const string GRILLAVACIA ="No existe ninguna Detalle de Monto de Cliente por Centro de Operación";  
		#endregion
