...
<%@ Page language="c#" Codebehind="BusquedaBuque.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.BusquedaBuque" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="610" align="center" border="0">
				<TR>
					<TD class="TituloPrincipal" colSpan="3"><asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> BUSQUEDA DE BUQUES</asp:label></TD>
				</TR>
				<TR>
					<TD align="right"></TD>
				</TR>
				<TR>
					<TD align="center">
						<TABLE class="tabla" id="Table6" cellSpacing="0" cellPadding="0" width="550" bgColor="#f5f5f5"
							...
							<TR>
								<TD class="TitFiltros" align="left">&nbsp;<INPUT id="hIdBuque" style="WIDTH: 16px; HEIGHT: 22px" type="hidden" size="1" name="hIdBuque"
										runat="server"><INPUT id="hBuque" style="WIDTH: 16px; HEIGHT: 22px" type="hidden" size="1" name="hBuque"
										runat="server"></TD>
								<TD class="combos"></TD>
								<TD class="combos"><asp:label id="lblDescripcion" runat="server" CssClass="normal">Nombre del Buque</asp:label></TD>
								<TD class="combos"></TD>
								<TD class="combos"></TD>
							</TR>
							<TR>
								...
								<TD class="combos"></TD>
								<TD class="combos"><asp:textbox id="txtBuque" runat="server" CssClass="normal" Width="370px"></asp:textbox></TD>
								<TD class="combos"><cc2:requireddomvalidator id="rfvBuque" runat="server" CssClass="normal" ControlToValidate="txtBuque">*</cc2:requireddomvalidator></TD>
						...
						<TABLE class="normal" id="Table1" cellSpacing="0" cellPadding="0" width="550" border="0">
							<TR>
								<TD align="center" colSpan="3"><cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" Width="600px" AllowSorting="True"
										AutoGenerateColumns="False" AllowPaging="True" RowHighlightColor="#E0E0E0" RowPositionEnabled="False" DataKeyField="IdBuque">
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NombreBuque" HeaderText="NOMBRE DEL BUQUE"></asp:BoundColumn>
										</Columns>
		...
		function PonerTexto()
			{ 
				opener.document.forms[0].hIdBuque.value =document.forms[0].hIdBuque.value;
				opener.document.forms[0].txtNombreBuque.value =document.forms[0].hBuque.value;
				window.close();
			} 
		</script>
	</body>
