...
{
	/// <summary>
	/// Summary description for AdministrarMaterial.
	/// </summary>
	public class AdministrarMaterial : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLDETALLE   = "DetalleMaterial.aspx?";
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if (oCMantenimientos.Eliminar(Convert.ToInt32(this.hCodigo.Value.ToString()),CNetAccessControl.GetIdUser(), Enumerados.ClasesTAD.MaterialTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(), "Gestión Comercial:Inf. Comercial", this.ToString(), "Se eliminó el Material Nro. " + this.hCodigo.ToString() + ".",Enumerados.NivelesErrorLog.I.ToString())); 
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				try
				{
					...
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestión Comercial:Inf. Comercial",this.ToString(),"Se consultó los Materiales.",Enumerados.NivelesErrorLog.I.ToString()));
		...
		{
			// TODO:  Add AdministrarMaterial.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministrarMaterial.LlenarGrillaOrdenamiento implementation
		}

		public DataTable ObtenerDatos()
		{
			CMantenimientos oCMantenimientos =  new CMantenimientos();
			return (oCMantenimientos.ListarTodosGrilla(Enumerados.ClasesNTAD.MaterialNTAD.ToString()));
		}

		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar,int indicePagina)
		{
			DataTable dtMaterial = this.ObtenerDatos();
			if(dtMaterial!=null)
			{
				DataView dwMaterial  = dtMaterial.DefaultView;
				dwMaterial.Sort      = columnaOrdenar ;
				dwMaterial.RowFilter = Utilitario.Helper.ObtenerFiltro(this);
				grid.DataSource      = dwMaterial;
				lblResultado.Visible = false;
				grid.Columns[POSICIONFOOTERTOTAL].FooterText = TEXTOFOOTERTOTAL;
				grid.Columns[POSICIONFOOTERTOTAL+1].FooterText = dwMaterial.Count.ToString();

			}
			else
			{
				grid.DataSource = dtMaterial;
		...
		{
			// TODO:  Add AdministrarMaterial.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add AdministrarMaterial.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add AdministrarMaterial.RegistrarJScript implementation
		}
		...
		{
			// TODO:  Add AdministrarMaterial.Exportar implementation
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[Utilitario.Constantes.POSICIONCONTADOR].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					...
					KEYQID+ Utilitario.Constantes.SIGNOIGUAL + Convert.ToString(dr[Enumerados.ColumnasMaterial.IdMaterial.ToString()]) +  Utilitario.Constantes.SIGNOAMPERSON + 
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,
					Utilitario.Helper.MostrarDatosEnCajaTexto("hCodigo",dr[Enumerados.ColumnasMaterial.IdMaterial.ToString()].ToString()));
			}	
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text = Helper.ElaborarFiltro(this.ObtenerDatos()
				, Utilitario.Enumerados.ColumnasMaterial.Descripcion + Utilitario.Constantes.SIGNOPUNTOYCOMA + DESCRIPCION
				, Utilitario.Constantes.SIGNOASTERISCO + TIPO + Utilitario.Constantes.SIGNOPUNTOYCOMA + TIPO
				, Utilitario.Constantes.SIGNOASTERISCO + MEDIDA + Utilitario.Constantes.SIGNOPUNTOYCOMA + Utilitario.Enumerados.ColumnasCostoMaterial.UnidadMedida);
		}
