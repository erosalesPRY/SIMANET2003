...
<%@ Page language="c#" Codebehind="AdministrarCostoManoObra.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.InformacionComercial.AdministrarCostoManoObra" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD class="Commands" colSpan="3">
						...
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administración de Costos de Mano de Obra</asp:label></TD>
				</TR>
				<TR>
								...
								<TD>
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="780" border="0">
										<TR>
											...
											<TD style="WIDTH: 115px" vAlign="middle" bgColor="#f0f0f0"><IMG id="ibtnFiltrarSeleccion" onclick="FiltroporSeleccion(1);" alt="Aplicar Filtro por Selección"
													src="../../imagenes/filtroPorSeleccion.JPG"></TD>
											<TD style="WIDTH: 115px" vAlign="middle" bgColor="#f0f0f0">
												<asp:imagebutton id="ibtnEliminaFiltro" runat="server" ImageUrl="../../imagenes/filtroEliminar.GIF"
													ToolTip="Eliminar Filtro.."></asp:imagebutton></TD>
											<TD bgColor="#f0f0f0"><IMG height="8" src="../../imagenes/spacer.gif" width="270"></TD>
											<TD bgColor="#f0f0f0">
									...
									<cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" ShowFooter="True" RowPositionEnabled="False"
										...
										<Columns>
											...
											<asp:BoundColumn Visible="False" DataField="IDMANOOBRA" SortExpression="IDMANOOBRA" HeaderText="IDMANOOBRA"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="IDCENTROOPERATIVO" SortExpression="IDCENTROOPERATIVO"
												HeaderText="IDCENTROOPERATIVO"></asp:BoundColumn>
											<asp:BoundColumn DataField="DESCRIPCION" SortExpression="DESCRIPCION" HeaderText="DESCRIPCION">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="TIPO" SortExpression="TIPO" HeaderText="TIPO MO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
