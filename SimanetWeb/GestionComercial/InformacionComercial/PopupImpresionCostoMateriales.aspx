<%@ Page language="c#" Codebehind="PopupImpresionCostoMateriales.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.InformacionComercial.PopupImpresionCostoMateriales" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" ShowFooter="True" AllowPaging="True" AutoGenerateColumns="False"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="UNIDADMEDIDA" HeaderText="UM"></asp:BoundColumn>
