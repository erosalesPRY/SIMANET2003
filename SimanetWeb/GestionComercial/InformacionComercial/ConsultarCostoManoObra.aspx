...
<%@ Page language="c#" Codebehind="ConsultarCostoManoObra.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.InformacionComercial.ConsultarCostoManoObra" %>
			...
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD class="Commands" colSpan="3">
						...
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Registros de Costos de Mano de Obra</asp:label></TD>
				</TR>
				<TR>
							...
							<TR>
								<TD>
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="780" border="0">
										<TR>
											<TD style="WIDTH: 89px" bgColor="#f0f0f0">
												<asp:imagebutton id="ibtnFiltrar" runat="server" ImageUrl="../../imagenes/filtrar.gif"></asp:imagebutton></TD>
											<TD vAlign="middle" bgColor="#f0f0f0"><IMG id="ibtnFiltrarSeleccion" onclick="FiltroporSeleccion(1);" alt="Aplicar Filtro por Selección"
									...
									<cc1:datagridweb id="grid" runat="server" ShowFooter="True" RowPositionEnabled="False" RowHighlightColor="#E0E0E0"
										AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" Width="780px" CssClass="HeaderGrilla">
