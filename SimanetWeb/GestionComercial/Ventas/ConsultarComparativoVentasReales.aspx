...
<%@ Page language="c#" Codebehind="ConsultarComparativoVentasReales.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Ventas.ConsultarComparativoVentasReales" %>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TBODY>
								<TR>
									<TD class="Commands" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestión Comercial > Ventas ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Comparativo de Ventas Ejecutadas</asp:label></TD>
								</TR>
								<TR>
											...
											<TR>
												<TD align="center" width="100%" colSpan="3">
													...
													<cc1:datagridweb id="dgConsultaMensual" runat="server" CssClass="HeaderGrilla" Width="780px" RowHighlightColor="#E0E0E0"
														...
														<Columns>
															<asp:BoundColumn DataField="centrooperativo" HeaderText="CENTRO DE OPERACIONES">
																<ItemStyle HorizontalAlign="Left"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="ventarealactual" HeaderText="A&#209;O ACTUAL">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="ventarealpasada" HeaderText="A&#209;O ANTERIOR">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
