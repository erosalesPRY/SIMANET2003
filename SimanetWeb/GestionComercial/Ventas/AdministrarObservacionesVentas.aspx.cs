	...
	public class AdministrarObservacionesVentas: System.Web.UI.Page, IPaginaBase
	{
		...
		private void eliminar()
		{
			...
			else
			{
				...
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó la Observacion de Venta Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
