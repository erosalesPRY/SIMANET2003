...
{
	/// <summary>
	/// Summary description for ConsultarVentasRealesDesagregadaMensual.
	/// </summary>
	public class ConsultarVentasRealesDesagregadaMensual: System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLIMPRESION = "PopupImpresionConsultarVentasRealesDesagregadaMensual.aspx";
		...
		public void LlenarGrilla()
		{
			...
			{
				//Mensual
				dtVentasMensual =  oCVentasReales.ConsultarVentasRealesDesagregadasMensual(Helper.FechaSimanet.ObtenerFechaSesion());
			}
			else
			{
				//Acumulado
				dtVentasMensual =  oCVentasReales.ConsultarVentasRealesDesagregadasAcumulada(Helper.FechaSimanet.ObtenerFechaSesion());
			}
		...
		{
			// TODO:  Add ConsultarVentasRealesDesagregadaMensual.LlenarGrillaOrdenamiento implementation
		}

		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			// TODO:  Add ConsultarVentasRealesDesagregadaMensual.LlenarGrillaOrdenamientoPaginacion implementation
		}
		...
		{
			// TODO:  Add ConsultarVentasRealesDesagregadaMensual.LlenarJScript implementation
		}

		public void RegistrarJScript()
		{
			// TODO:  Add ConsultarVentasRealesDesagregadaMensual.RegistrarJScript implementation
		}
		...
		{
			// TODO:  Add ConsultarVentasRealesDesagregadaMensual.Exportar implementation
		}
		...
		private void dgConsultaMensual_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				if(e.Item.Cells[Constantes.POSICIONCONTADOR].Text.StartsWith(NombreGlosaTotales))
				{
					...
					e.Item.Cells[Columna4].Text = Convert.ToDouble(e.Item.Cells[Columna4].Text).ToString(Constantes.FORMATODECIMAL4);
