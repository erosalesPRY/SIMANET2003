<%@ Page language="c#" Codebehind="PopupImpresionAdministrarVentasPresupuestadas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Ventas.PopupImpresionAdministrarVentasPresupuestadas" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="7"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="linea" HeaderText="LN"></asp:BoundColumn>
											<asp:BoundColumn DataField="RAZONSOCIAL" HeaderText="CLIENTE">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="DESCRIPCIONPROYECTO" HeaderText="PROYECTO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											...
											<asp:BoundColumn DataField="FECHAPRESUPUESTO" HeaderText="FECHA" DataFormatString="{0:dd-MM-yyyy}">
