...
<%@ Page language="c#" Codebehind="ConsultarVentasRealesConPromotorVsSinPromotor.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Ventas.ConsultarVentasRealesConPromotorVsSinPromotor" %>
				...
				<TR>
					<TD vAlign="top">
						<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TBODY>
								<TR>
									<TD class="Commands" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestión Comercial > Ventas ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Ventas Ejecutadas con Promotor vs Ventas Ejecutadas sin Promotor</asp:label></TD>
								</TR>
								<TR>
												...
												<TD align="center" width="100%" colSpan="3">
													...
													<cc1:datagridweb id="dgConsultaMensual" runat="server" CssClass="HeaderGrilla" Width="780px" RowHighlightColor="#E0E0E0"
														...
														<Columns>
															...
															<asp:BoundColumn DataField="VentasConpromotor" HeaderText="VENTAS CON PROMOTOR">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="ContribucionConPromotor" HeaderText="CONTRIBUCION">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="VentaSinPromotor" HeaderText="VENTAS SIN PROMOTOR">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="ContribucionSinPromotor" HeaderText="CONTRIBUCION">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
															<asp:BoundColumn DataField="TotalVentas" HeaderText="TOTAL VENTAS">
																<ItemStyle HorizontalAlign="Right"></ItemStyle>
															</asp:BoundColumn>
