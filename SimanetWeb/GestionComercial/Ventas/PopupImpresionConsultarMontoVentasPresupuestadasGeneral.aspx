<%@ Page language="c#" Codebehind="PopupImpresionConsultarMontoVentasPresupuestadasGeneral.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Ventas.PopupImpresionConsultarMontoVentasPresupuestadasGeneral" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PopupImpresionConsultarMontoVentasPresupuestadasGeneral</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="730" align="center" border="0">
				...
				<TR>
					<TD align="right"><asp:datagrid id="dgMonto" runat="server" CssClass="HeaderGrilla" AutoGenerateColumns="False"
							Width="720px">
							...
							<Columns>
								<asp:BoundColumn DataField="LineaNegocio" HeaderText="LN" FooterText="TOTAL">
