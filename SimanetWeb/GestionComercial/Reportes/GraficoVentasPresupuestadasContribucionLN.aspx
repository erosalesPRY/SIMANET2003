...
<%@ Page language="c#" Codebehind="GraficoVentasPresupuestadasContribucionLN.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Reportes.GraficoVentasPresupuestadasContribucionLN" %>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top" align="center">
						<TABLE id="Table2" style="WIDTH: 650px; HEIGHT: 132px" cellSpacing="0" cellPadding="0"
							border="0">
							<TR>
								<TD align="right">
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" align="left" border="0">
										<TR>
											<TD></TD>
											<TD width="100%">
												<TABLE class="tabla" id="Table7" cellSpacing="0" cellPadding="0" width="200" border="0">
													<TR>
														<TD>
		...
		<script type="text/javascript">
			...
			// ]]>
				(function(){
					...
					var oDvCrak = document.all["dvCrak"];
					oDvCrak.style.position = "absolute";
					oDvCrak.style.left =xLeft;
					oDvCrak.style.top ="180px"//"34px";
				})()
		</script>
		<SCRIPT>
