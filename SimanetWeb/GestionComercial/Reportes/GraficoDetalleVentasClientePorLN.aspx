<%@ Page language="c#" Codebehind="GraficoDetalleVentasClientePorLN.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Reportes.GraficoDetalleVentasClientePorLN" %>
...
<HTML>
	<HEAD>
		<title>GraficoDetalleVentasCientePorLN</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" onunload="SubirHistorial();">
		<form id="Visual" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="Commands"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Comercial > Ventas ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> GraficoDetalle Ventas Cliente Por Linea de Negocio</asp:label></TD>
				</TR>
				<TR>
