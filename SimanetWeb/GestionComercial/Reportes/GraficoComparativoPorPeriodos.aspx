<%@ Page language="c#" Codebehind="GraficoComparativoPorPeriodos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Reportes.GraficoComparativoPorPeriodos" %>
				...
				<TR>
					<TD vAlign="top" align="center">
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="780" border="0">
							<TR>
								<TD align="right"><IMG height="8" src="../../imagenes/spacer.gif" width="360"></TD>
							</TR>
							<TR>
								<TD align="center">
							...
							<TR>
								<TD align="left"><IMG id="ibtnAtras" style="CURSOR: hand" onclick="HistorialIrAtras();" alt="" src="../../imagenes/atras.gif"><INPUT id="NombreArchivoData" style="WIDTH: 76px; HEIGHT: 22px" type="hidden" size="7"
										name="NombreArchivoTXTCallao" runat="server"><INPUT id="RutaArchivo" type="hidden" name="RutaArchivo" runat="server"><INPUT id="NombreArchivoTXT" type="hidden" name="NombreArchivoTXT" runat="server"></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
