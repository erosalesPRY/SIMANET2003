...
<%@ Page language="c#" Codebehind="GraficoVentasAcumuladasporLineadeNegocio.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Reportes.GraficoVentasAcumuladasporLineadeNegocio" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();"
		...
		<form id="Visual" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="Commands"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Comercial > Ventas ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual">Ventas Reales Acumuladas por Línea de Negocio</asp:label></TD>
				</TR>
				<TR>
					<TD vAlign="top" align="center">
						<TABLE id="Table2" style="WIDTH: 644px; HEIGHT: 134px" cellSpacing="0" cellPadding="0"
							width="644" border="0">
							<TR>
								<TD align="right"><IMG style="WIDTH: 130px" height="19" src="../../imagenes/spacer.gif" width="130"></TD>
							</TR>
							<TR>
								<TD align="center">
									<TABLE id="Table4" style="FILTER: alpha(style=1, opacity=20, finishOpacity=70, startX=0,finishX=0, startY= 0,finishY=0); WIDTH: 47px; HEIGHT: 40px"
										...
										<TR>
											...
											<TD>
												<DIV id="flashcontent"><STRONG>Player</STRONG>
												</DIV>
											</TD>
							...
							<TR>
								<TD align="center"><asp:label id="lblResultado" runat="server" CssClass="ResultadoBusqueda" Visible="False"></asp:label>
									<div id="dvCrak"><IMG src="/SimaNetWeb/imagenes/Otros/Bordes/CenterLeft.gif"></div>
								</TD>
							</TR>
							<TR>
