<%@ Page language="c#" Codebehind="GraficoHistoricoVentasEjecutadasPorCOyLN.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.Reportes.GraficoHistoricoVentasEjecutadasPorCOyLN" %>
...
<HTML>
	<HEAD>
		<title>GraficoHistoricoVentasEjecutadasPorCOyLN</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" onunload="SubirHistorial();">
		<form id="Visual" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="Commands" style="HEIGHT: 19px"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Comercial > Ventas ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Grafico Historico de Ventas Ejecutadas Por Centro de Operacion y Linea de Negocio</asp:label></TD>
				</TR>
				<TR>
					<TD align="center"><asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"></asp:label></TD>
				</TR>
				<TR>
					<TD align="center"><asp:label id="lblTitulo1" runat="server" CssClass="TituloPrincipal">lblTitulo1</asp:label></TD>
				</TR>
				<TR>
