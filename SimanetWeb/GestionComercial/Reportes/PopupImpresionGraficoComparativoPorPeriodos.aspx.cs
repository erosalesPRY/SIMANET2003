...
{
	public class PopupImpresionGraficoComparativoPorPeriodos : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		public void LlenarGrilla()
		{
			...
			ChartImage.ImageUrl = URLGENERADORGRAFICOS + 
				...
				VALORIMPRESION + Constantes.SIGNOIGUAL + Boolean.TrueString	+ Constantes.SIGNOAMPERSON +
				KEYALTO + Constantes.SIGNOIGUAL + alto.ToString();
