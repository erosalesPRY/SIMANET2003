<%@ Page language="c#" Codebehind="PopupImpresionAdministrarGastosDirectorio.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionAdministrarGastosDirectorio" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="7"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="Descripcion" HeaderText="DETALLE GASTO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="Lugar" HeaderText="LUGAR">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="Nombre" HeaderText="CENTRO COSTO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											...
											<asp:BoundColumn DataField="FechaGasto" HeaderText="FECHA DE GASTO" DataFormatString="{0:dd-MM-yyyy}">
