...
{
	/// <summary>
	/// Summary description for AdministracionRegistroInvitaciones.
	/// </summary>
	public class AdministracionRegistroInvitaciones : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		{			
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.RegistroInvitacionesTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Registro de Invitaciones Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		{
			// TODO:  Add AdministracionRegistroInvitaciones.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministracionRegistroInvitaciones.LlenarGrillaOrdenamiento implementation
		}
		...
		{
			// TODO:  Add AdministracionRegistroInvitaciones.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add AdministracionRegistroInvitaciones.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add AdministracionRegistroInvitaciones.RegistrarJScript implementation
		}
		...
		/// <summary>
		/// Abre la Pagina para Agregar una Invitacion
		/// </summary>
