...
<%@ Page language="c#" Codebehind="DetalleVideos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.DetalleVideos" %>
						...
						<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" width="100%" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual">Registro de Videos</asp:label></TD>
							</TR>
							<TR>
								<TD align="center">
												...
												<TABLE class="normal" id="Table7" cellSpacing="0" cellPadding="0" width="470" align="center"
													...
													<TR>
														<TD class="normal" vAlign="top" bgColor="#335eb4">
															<asp:label id="lblCodigoVideo" runat="server" CssClass="TextoBlanco">Codigo de Video:</asp:label>
														</TD>
														<TD class="normal" bgColor="#dddddd" colSpan="4">
															<asp:textbox id="txtCodigoVideo" runat="server" CssClass="normaldetalle" Width="136px" MaxLength="80"></asp:textbox></TD>
														<TD class="normal">
															<cc2:RequiredDomValidator id="rfvCodigoVideo" runat="server" ControlToValidate="txtCodigoVideo">*</cc2:RequiredDomValidator></TD>
													</TR>
													<TR>
														<TD class="normal" vAlign="top" bgColor="#335eb4">
															<asp:label id="lblRutaFisica" runat="server" CssClass="TextoBlanco">Ruta Fisica:</asp:label></TD>
