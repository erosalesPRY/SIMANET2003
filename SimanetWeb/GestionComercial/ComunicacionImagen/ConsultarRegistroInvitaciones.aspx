...
<%@ Page language="c#" Codebehind="ConsultarRegistroInvitaciones.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.ConsultarRegistroInvitaciones" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Consulta de Registro de Invitaciones</asp:label></TD>
							</TR>
							<TR>
								<TD class="TituloPrincipal" colSpan="3" align="center">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> CONSULTA DE REGISTRO DE INVITACIONES</asp:label></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD align="center" vAlign="top">
									<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="780" border="0">
											...
											<TD>
												<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="780" align="center" border="0"
													...
													<TR>
														...
														<TD bgColor="#f0f0f0"><IMG height="8" src="../../imagenes/spacer.gif" width="370"></TD>
														<TD bgColor="#f0f0f0">
															<asp:imagebutton id="ibtnExportar" runat="server" ImageUrl="../../imagenes/bt_exportar.GIF"></asp:imagebutton></TD>
														<TD bgColor="#f0f0f0">
												...
												<cc1:datagridweb id="grid" runat="server" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="FechaLanzamiento" SortExpression="FechaLanzamiento" HeaderText="LANZAMIENTO" DataFormatString="{0:dd-MM-yyyy}">
										...
										<TR>
											<TD align="center">
												<asp:datagrid id="gridExportacion" runat="server" CssClass="HeaderGrilla" AutoGenerateColumns="False"
													PageSize="1" Width="1px" Height="1px">
													<AlternatingItemStyle CssClass="AlternateItemGrilla"></AlternatingItemStyle>
													<ItemStyle CssClass="ItemGrilla"></ItemStyle>
													<HeaderStyle CssClass="HeaderGrilla"></HeaderStyle>
													<FooterStyle CssClass="FooterGrilla"></FooterStyle>
													<Columns>
														<asp:BoundColumn DataField="NombrePersona" HeaderText="NOMBRES">
															<ItemStyle HorizontalAlign="Left"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="FechaLanzamiento" HeaderText="LANZAMIENTO" DataFormatString="{0:dd-MM-yyyy}">
															<ItemStyle HorizontalAlign="Left"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="IdBuque" HeaderText="BUQUE"></asp:BoundColumn>
													</Columns>
