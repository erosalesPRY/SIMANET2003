...
<%@ Page language="c#" Codebehind="AdministracionArticulosRelacionesPublicas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.AdministracionArticulosRelacionesPublicas" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Registro de Artículos destinados a Relaciones Publicas</asp:label></TD>
							</TR>
							<TR>
								<TD class="TituloPrincipal" colSpan="3" align="center">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> ADMINISTRACION DE ARTICULOS DESTINADOS A RELACIONES PUBLICAS</asp:label></TD>
							</TR>
							<TR>
											...
											<TD>
												...
												<cc1:datagridweb id="grid" runat="server" PageSize="7" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:BoundColumn Visible="False" DataField="IdPresenteRelacionPublica" SortExpression="IdPresenteRelacionPublica"
															HeaderText="IdPresenteRelacionPublica"></asp:BoundColumn>
														...
														<asp:BoundColumn DataField="CantidadMinima" SortExpression="CantidadMinima" HeaderText="MINIMO"></asp:BoundColumn>
														<asp:BoundColumn DataField="CantidadMaxima" SortExpression="CantidadMaxima" HeaderText="MAXIMO">
														...
														<asp:BoundColumn DataField="Existencia" SortExpression="Existencia" HeaderText="EXISTENCIA"></asp:BoundColumn>
													</Columns>
