...
{
	/// <summary>
	/// Summary description for AdministrarPresentesOtorgadosPorTipoPersona.
	/// </summary>
	public class AdministrarPresentesOtorgadosPorTipoPersona : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		#region Constantes
		//Ordenamiento
		const string COLORDENAMIENTO = "IdListaProtocolar";
		...
		//Paginas
		const string URLDETALLE = "DetallePresentesOtorgadosPorTipoPersona.aspx?";
		const string URLIMPRESION = "PopupImpresionConsultarPresentesOtorgadosPorTipoPersona.aspx?";
		const string URLDETALLEADMINISTRACION = "AdministrarPresentesOtorgadosFamiliares.aspx?";
		...
		{
			// TODO:  Add AdministrarPresentesOtorgadosPorTipoPersona.LlenarGrilla implementation
		}

		
		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministrarPresentesOtorgadosPorTipoPersona.LlenarGrillaOrdenamiento implementation
		}
		...
		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar,int indicePagina)
		{
			...
			if(dtPresentesOtorgados!=null)
			{
				...
				if(dwPresentesOtorgados.Count > POSICIONINICIALCOMBO)
				{
		...
		{
			// TODO:  Add AdministrarPresentesOtorgadosPorTipoPersona.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add AdministrarPresentesOtorgadosPorTipoPersona.RegistrandoJScript implementation
		}
		...
		{
			// TODO:  Add AdministrarPresentesOtorgadosPorTipoPersona.Exportar implementation
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[Constantes.POSICIONCONTADOR].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					Helper.MostrarVentana(URLDETALLE,KEYQID+ Utilitario.Constantes.SIGNOIGUAL + Convert.ToString(dr[Enumerados.ColumnasPresentesOtorgadosPorTipoPersona.IdListaProtocolar.ToString()]) +  Utilitario.Constantes.SIGNOAMPERSON + 
		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.PresentesOtorgadosTipoPersonaTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Presente Otorgado Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		private void ibtnPresentesFamiliares_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			{
				Page.Response.Redirect(URLDETALLEADMINISTRACION +
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos()
				...
				,Utilitario.Enumerados.ColumnasPresentesOtorgadosPorTipoPersona.NombreClientePersonal.ToString()+ ";Nombre Cliente / Personal / Visita"
				...
				,Utilitario.Enumerados.ColumnasPresentesOtorgadosPorTipoPersona.CantidadAtendida.ToString()+ ";Cantidad Entregada"
				);
		}
