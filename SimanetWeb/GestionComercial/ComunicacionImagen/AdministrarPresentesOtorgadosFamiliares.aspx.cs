		...
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.PresentesOtorgadosFamiliaresTAD.ToString())>0)
				{
					...
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Presente Otorgado a Familiares Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
