<%@ Page language="c#" Codebehind="PopupImpresionAdministrarGastosRepresentacion.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionAdministrarGastosRepresentacion" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="7"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="MotivoPresente" HeaderText="MOTIVO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											...
											<asp:BoundColumn DataField="FechaGasto" HeaderText="FECHA GASTO" DataFormatString="{0:dd-MM-yyyy}">
