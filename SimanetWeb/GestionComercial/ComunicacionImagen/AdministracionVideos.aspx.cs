...
{
	/// <summary>
	/// Summary description for AdministracionVideos.
	/// </summary>
	public class AdministracionVideos : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		const string TituloConstante = "ADMINISTRACION DE VIDEOS";
		...
		{			
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.VideoTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Video Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		{
			// TODO:  Add AdministracionVideos.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministracionVideos.LlenarGrillaOrdenamiento implementation
		}
		...
		{
			// TODO:  Add AdministracionVideos.LlenarCombos implementation
		}
		...
		{
			// TODO:  Add AdministracionVideos.RegistrarJScript implementation
		}
		...
		{
			// TODO:  Add AdministracionVideos.Exportar implementation
		}
