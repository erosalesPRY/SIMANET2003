...
<%@ Page language="c#" Codebehind="AdministracionVideos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.AdministracionVideos" %>
											...
											<TD>
												...
												<cc1:datagridweb id="grid" runat="server" PageSize="7" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:BoundColumn Visible="False" DataField="IdCodigoVideo"></asp:BoundColumn>
														<asp:BoundColumn DataField="CodigoVideo" SortExpression="CodigoVideo" HeaderText="CODIGO">
