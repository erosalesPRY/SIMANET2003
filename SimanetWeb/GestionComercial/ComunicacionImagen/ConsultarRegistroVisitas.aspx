...
<%@ Page language="c#" Codebehind="ConsultarRegistroVisitas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.ConsultarRegistroVisitas" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Consulta de Registro de Visitas</asp:label></TD>
							</TR>
							<TR>
								<TD class="TituloPrincipal" colSpan="3" align="center">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> CONSULTA DE REGISTRO DE VISITAS</asp:label></TD>
							</TR>
							<TR>
