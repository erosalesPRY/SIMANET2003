<%@ Page language="c#" Codebehind="PopupImpresionConsultarGastosPasajesAereos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionConsultarGastosPasajesAereos" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="7"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NombreAerolinea" HeaderText="AEROLINEA">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											...
											<asp:BoundColumn DataField="Monto" HeaderText="MONTO" DataFormatString="{0:###,##0.00}"></asp:BoundColumn>
