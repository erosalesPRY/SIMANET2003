...
{
	/// <summary>
	/// Summary description for AdministracionRegistroVisitas.
	/// </summary>
	public class AdministracionRegistroVisitas : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		protected System.Web.UI.WebControls.ImageButton ibtnVisitas;
		...
		const string URLVISITAS = "AdministracionVisitas.aspx";
		...
		{			
			...
			else
			{
				...
				if(oCRegistroVisitas.EliminarRegistroVisitas(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Registro de Visitas Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		{    
			...
			this.ibtnVisitas.Click += new System.Web.UI.ImageClickEventHandler(this.ibtnVisitas_Click);
		...
		{
			// TODO:  Add AdministracionRegistroVisitas.LlenarGrilla implementation
		}
		...
		public void LlenarJScript()
		{
			...
			ibtnVisitas.Attributes.Add(Constantes.EVENTOMOUSEDOWN,Helper.HistorialIrAdelantePersonalizado(Utilitario.Constantes.VACIO));
			ibtnVisitas.Attributes.Add(Utilitario.Constantes.EVENTOCLICK, Utilitario.Constantes.POPUPDEESPERA);
		...
		{
			ListItem lItem1 = new ListItem(Enumerados.TiposOrigenVistaEntidad.Visita.ToString(),Convert.ToInt32(Enumerados.TiposOrigenVistaEntidad.Visita).ToString());
			ListItem lItem2 = new ListItem(Enumerados.TiposOrigenVistaEntidad.Cliente.ToString(),Convert.ToInt32(Enumerados.TiposOrigenVistaEntidad.Cliente).ToString());
			ListItem lItem3 = new ListItem(Enumerados.TiposOrigenVistaEntidad.Personal.ToString(),Convert.ToInt32(Enumerados.TiposOrigenVistaEntidad.Personal).ToString());
		...
		/// <summary>
		/// Abre la Pagina para Agregar una Visita
		/// </summary>
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos()
					...
					,"*" + Utilitario.Enumerados.ColumnasVisita.IdUbigeo.ToString() + ";Nacionalidad"
		...
		private void ibtnVisitas_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			Page.Response.Redirect(URLVISITAS);
		}
