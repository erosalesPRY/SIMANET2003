...
namespace SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen
{
	...
	/// </summary>
	public class AdministracionArticulosRelacionesPublicas : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLDETALLE = "DetalleArticulosRelacionesPublicas.aspx?";
		...
		{			
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.PresenteRelacionPublicaTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Presente Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.LlenarGrillaOrdenamiento implementation
		}
		...
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.RegistrarJScript implementation
		}
		...
		{
			// TODO:  Add AdministracionArticulosRelacionesPublicas.Exportar implementation
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[Constantes.POSICIONCONTADOR].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					...
					Convert.ToString(dr[Enumerados.ColumnasPresentes.IdPresenteRelacionPublica.ToString()]) +  
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,Utilitario.Helper.MostrarDatosEnCajaTexto("hCodigo",dr[Enumerados.ColumnasPresentes.IdPresenteRelacionPublica.ToString()].ToString()));
				Helper.FiltroporSeleccionConfiguraColumna(e,grid);
			}
		}

		/// <summary>
		/// Abre la Pagina para Agregar una Articulo de Relaciones Publicas
		/// </summary>
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos()
					,Constantes.SIGNOASTERISCO  + Utilitario.Enumerados.ColumnasPresentes.NombreArticulo.ToString()+";Articulo"
					,Utilitario.Enumerados.ColumnasPresentes.Descripcion.ToString()+ ";Descripcion"
					,Utilitario.Enumerados.ColumnasPresentes.CantidadMinima.ToString()+ ";Cantidad Minima"
					,Utilitario.Enumerados.ColumnasPresentes.CantidadMaxima.ToString()+ ";Cantidad Maxima"
					...
					,Utilitario.Enumerados.ColumnasPresentes.Existencia.ToString()+ ";Existencia");
		}
