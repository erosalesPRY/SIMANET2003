<%@ Page language="c#" Codebehind="PopupImpresionAdministracionArticulosRelacionesPublicas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionAdministracionArticulosRelacionesPublicas" %>
...
<Columns>
<asp:BoundColumn DataField="NombreArticulo" HeaderText="ARTICULO">
...
<asp:BoundColumn DataField="CantidadMinima" HeaderText="MINIMO"></asp:BoundColumn>
<asp:BoundColumn DataField="CantidadMaxima" SortExpression="Maximo" HeaderText="MAXIMO"></asp:BoundColumn>
<asp:BoundColumn DataField="CantidadIngreso" HeaderText="INGRESO"></asp:BoundColumn>
<asp:BoundColumn DataField="CantidadEgreso" HeaderText="EGRESO"></asp:BoundColumn>
<asp:BoundColumn DataField="Existencia" HeaderText="EXISTENCIA"></asp:BoundColumn>
</Columns>
