...
{
	/// <summary>
	/// Summary description for AdministrarGastosDirectorio.
	/// </summary>
	public class AdministrarGastosDirectorio : System.Web.UI.Page,IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLDETALLE = "DetalleGastosDirectorio.aspx?";
		const string URLIMPRESION = "PopupImpresionAdministrarGastosDirectorio.aspx";
		...
		/// <summary>
		/// Elimina los Gastos del Directorio
		/// </summary>
		private void eliminar()
		{
			...
			else
			{
				...
				if(oCMantenimientos.Eliminar(Convert.ToInt32(hCodigo.Value),CNetAccessControl.GetIdUser(),Enumerados.ClasesTAD.GastoDirectorioTAD.ToString())>0)
				{
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se eliminó el Gasto del Directorio Nro. " + hCodigo.Value +"." ,Enumerados.NivelesErrorLog.I.ToString()));
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				try
				{
					...
					//Graba en el Log la acción ejecutada
					LogAplicativo.GrabarLogAplicativoArchivo(new LogAplicativo(CNetAccessControl.GetUserName(),"Gestion Comercial",this.ToString(),"Se consultó los Gastos del Directorio.",Enumerados.NivelesErrorLog.I.ToString()));
		...
		{
			// TODO:  Add AdministrarGastosDirectorio.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add AdministrarGastosDirectorio.LlenarGrillaOrdenamiento implementation
		}

		public DataTable ObtenerDatos()
		{
			CMantenimientos oCMantenimientos =  new CMantenimientos();
			return (oCMantenimientos.ListarTodosGrilla(Enumerados.ClasesNTAD.GastoDirectorioNTAD.ToString()));
		}
		...
		{
			// TODO:  Add AdministrarGastosDirectorio.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add AdministrarGastosDirectorio.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add AdministrarGastosDirectorio.RegistrarJScript implementation
		}
		...
		{
			// TODO:  Add AdministrarGastosDirectorio.Exportar implementation
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[Constantes.POSICIONCONTADOR].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
					...
					Convert.ToString(dr[Enumerados.ColumnasGastosDirectorio.IdGastoDirectorio.ToString()]) +  
				...
				Helper.SeleccionarItemGrillaOnClickMoverRaton(e,Utilitario.Helper.MostrarDatosEnCajaTexto("hCodigo",dr[Enumerados.ColumnasGastosDirectorio.IdGastoDirectorio.ToString()].ToString()));
				Helper.FiltroporSeleccionConfiguraColumna(e,grid);
			}	
		}

		/// <summary>
		/// Abre la Pagina para Agregar un Gasto de Directorio
		/// </summary>
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos()
				...
				,Utilitario.Enumerados.ColumnasGastosDirectorio.Nombre.ToString() + ";Nombre"
				...
				,Utilitario.Enumerados.ColumnasGastosDirectorio.FechaGasto.ToString() + ";Fecha del Gasto");
		}
