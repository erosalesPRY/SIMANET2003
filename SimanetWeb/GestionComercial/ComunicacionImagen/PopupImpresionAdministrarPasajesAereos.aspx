<%@ Page language="c#" Codebehind="PopupImpresionAdministrarPasajesAereos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionAdministrarPasajesAereos" %>
						...
						<TABLE class="normal" id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="720px"
										...
										<Columns>
											<asp:BoundColumn DataField="Aerolinea" HeaderText="AEROLINEA"></asp:BoundColumn>
											<asp:BoundColumn DataField="RUTA" HeaderText="RUTA"></asp:BoundColumn>
											<asp:BoundColumn DataField="FECHAVUELO" HeaderText="FECHA DEL VUELO" DataFormatString="{0:dd-MM-yyyy}">
