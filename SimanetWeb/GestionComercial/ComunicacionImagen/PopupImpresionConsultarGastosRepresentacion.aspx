<%@ Page language="c#" Codebehind="PopupImpresionConsultarGastosRepresentacion.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.PopupImpresionConsultarGastosRepresentacion" %>
							...
							<TR>
								<TD align="center" width="100%" colSpan="6" rowSpan="3"><asp:datagrid id="grid" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="7"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NombrePromotor" HeaderText="DETALLES">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="MotivoPresente" HeaderText="MOTIVO"></asp:BoundColumn>
											<asp:BoundColumn DataField="NombreArticulo" HeaderText="PRESENTE OTORGADO">
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="Cantidad" HeaderText="CANTIDAD ENTREGADA"></asp:BoundColumn>
											...
											<asp:BoundColumn DataField="FechaGasto" HeaderText="FECHA GASTO" DataFormatString="{0:dd-MM-yyyy}"></asp:BoundColumn>
										</Columns>
