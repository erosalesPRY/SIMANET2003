...
<%@ Page language="c#" Codebehind="AdministracionVisitas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionComercial.ComunicacionImagen.AdministracionVisitas" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR>
								<TD class="Commands" colSpan="3">
									...
									<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Registro de Visita</asp:label></TD>
							</TR>
							<TR>
								<TD class="TituloPrincipal" colSpan="3" align="center">
									<asp:label id="lblTitulo" runat="server" CssClass="TituloPrincipal"> ADMINISTRACION DE VISITAS</asp:label></TD>
							</TR>
							<TR>
											...
											<TD>
												...
												<cc1:datagridweb id="grid" runat="server" PageSize="7" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:BoundColumn Visible="False" DataField="IdVisita"></asp:BoundColumn>
														<asp:BoundColumn DataField="Nombres" SortExpression="Nombres" HeaderText="NOMBRES">
															<ItemStyle HorizontalAlign="Left"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="IdTipoVisita" SortExpression="IdTipoVisita" HeaderText="RANGO">
															<ItemStyle HorizontalAlign="Left"></ItemStyle>
														</asp:BoundColumn>
														...
														<asp:BoundColumn DataField="Onomastico" SortExpression="Onomastico" HeaderText="ONOMASTICO"></asp:BoundColumn>
