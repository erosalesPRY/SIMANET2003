<%@ Page language="c#" Codebehind="AdministrarVerificacionesPorAcciones.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionIntegrada.AdministrarVerificacionesPorAcciones" %>
				...
				<TR>
					<TD vAlign="top" width="100%" align="center">
						<TABLE id="Table1" border="0" cellSpacing="1" cellPadding="1" width="100%">
							<TR>
								<TD width="100%" colSpan="2"><asp:datagrid style="Z-INDEX: 0" id="GridVerifica" runat="server" Width="100%" AutoGenerateColumns="False">
						...
						<INPUT style="WIDTH: 84px; HEIGHT: 22px" id="hIdsAcciones" size="8" type="hidden" runat="server">
						<INPUT style="Z-INDEX: 0; WIDTH: 90px; HEIGHT: 22px" id="hIdGrupoVerificacion" size="9"
