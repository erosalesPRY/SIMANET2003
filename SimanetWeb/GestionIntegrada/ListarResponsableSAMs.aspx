<%@ Page language="c#" Codebehind="ListarResponsableSAMs.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionIntegrada.ListarResponsableSAMs" %>
				...
				<TR>
					<TD vAlign="top" align="center" width="100%">
						<TABLE id="Table1" border="0" cellSpacing="1" cellPadding="1" width="100%">
							...
							<TR>
								<TD>
									<cc1:datagridweb style="Z-INDEX: 0" id="grid" runat="server" Width="100%" PageSize="15"
