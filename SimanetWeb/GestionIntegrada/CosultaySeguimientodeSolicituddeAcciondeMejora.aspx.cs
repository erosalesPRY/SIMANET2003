...
{
	/// <summary>
	/// Summary description for CosultaySeguimientodeSolicituddeAcciondeMejora.
	/// </summary>
	public class CosultaySeguimientodeSolicituddeAcciondeMejora : System.Web.UI.Page,IPaginaBase
	{
		...
		{
			get{return Convert.ToInt32(Page.Request.Params[KEYQTIPONOR]);}
		}
		public int IdTipoAuditoria
		{
			get{return Convert.ToInt32(Page.Request.Params[KEYTIPOAUD]);}
		}
		public int IdTipo
		{
			get{return Convert.ToInt32(Page.Request.Params[KEYTIPO]);}
		}
		...
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.LlenarGrillaOrdenamiento implementation
		}
		private DataTable ObtenerDatos()
		{
			...
			if(Page.Request.Params[KEYQTIPONOR]!=null)
			{
				...
				DataTable dt =  (new CSolicituddeAcciondeMejora()).ListarPorNormaTipoyAño(this.IdTipoNorma,this.IdTipoAuditoria,this.Periodo,this.IdTipo,0);
				return dt;
			}
			else{
				return (new CSolicituddeAcciondeMejora()).ListarDatosGrilla("0",0,Convert.ToInt32(this.ddlNorma.SelectedValue),Convert.ToInt32(this.ddlDestino.SelectedValue));
			}
		}
		...
		public void LlenarCombos()
		{
			...
			ddlDestino.DataSource = (new CSAMDestino()).ListarAreadeCentrosPorUsuario();
			ddlDestino.DataTextField="NombreArea";
		...
		{
			Session["dtSAM"] = this.ObtenerDatos();
			if(Page.Request.Params[Utilitario.Constantes.KEYNOMBREFUNCIONALIDAD]!=null)
			{
				lblPagina.Text = Page.Request.Params[Utilitario.Constantes.KEYNOMBREFUNCIONALIDAD].ToString();
			}
			/*Image oimg = new Image();
			oimg.ImageUrl=Helper.ObtenerFotoPersonal("5732");
			oimg.CssClass="imgCircular";
			oimg.Height=85;
			ContextReponsable.Controls.Add(oimg);*/
		}

		public void LlenarJScript()
		{
			this.ibtnImprimir.Style.Add("display","none");
			this.ibtnImprimir.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,Helper.HistorialIrAdelantePersonalizado("hGridPaginaSort","hGridPagina","hCodigo","hIdSAM","hIdDestino")+Helper.PopupDeEspera());
		}

		public void RegistrarJScript()
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add CosultaySeguimientodeSolicituddeAcciondeMejora.ValidarFiltros implementation
			return false;
		}
			...
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				try
				{
					foreach(DataRow dri in (new CSAMDestino()).ListarTodosGrilla(dr["IdSAM"].ToString(),"0").Rows)
					{
						...
						TBLItem.Rows[0].Attributes["PRIVILEGIO"]=Privilegio.ToString();
						//TBLItem.Border=4;
		...
		{
			DataTable dt = (DataTable)Session["dtSAM"];
