...
<%@ Page language="c#" Codebehind="AdministrarExamenMedico.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionSeguridadIndustrial.AdministrarExamenMedico" %>
	...
	<body onkeypress="if(event.keyCode==13)return false;" onunload="SubirHistorial();" onload="ObtenerHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" border="0" cellSpacing="0" cellPadding="0" width="100%">
				...
				<TR>
					<TD class="commands"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio >Gestión de seguridad></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> > Administración examen médico></asp:label>
						<asp:HyperLink id="HyperLink1" runat="server" NavigateUrl="AdministraFichaMedica.aspx" Visible="False">HyperLink</asp:HyperLink></TD>
				</TR>
				<TR>
					<TD align="center">
						<TABLE style="WIDTH: 1097px" id="Table2" border="0" cellSpacing="0" cellPadding="0" width="1097">
							...
							<TR>
								<TD vAlign="top" width="1%" align="center"><cc1:datagridweb id="grid" runat="server" CssClass="HeaderGrilla" Width="100%" Height="1px" AllowSorting="True"
										AutoGenerateColumns="False" RowHighlightColor="#E0E0E0" RowPositionEnabled="False" AllowPaging="True" ShowFooter="True" PageSize="15">
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NombreCentroMedico" SortExpression="NombreCentroMedico" HeaderText="CENTRO MEDICO">
												<HeaderStyle Width="10%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="habilitado" HeaderText="HABILITADO">
												<HeaderStyle Width="2%"></HeaderStyle>
											</asp:BoundColumn>
											<asp:TemplateColumn>
