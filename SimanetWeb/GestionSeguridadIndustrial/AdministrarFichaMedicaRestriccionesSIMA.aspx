...
<%@ Page language="c#" Codebehind="AdministrarFichaMedicaRestriccionesSIMA.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionSeguridadIndustrial.AdministrarFichaMedicaRestriccionesSIMA" %>
...
<body onkeypress="if(event.keyCode==13)return false;" onunload=SubirHistorial(); 
onload=ObtenerHistorial(); bottomMargin=0 leftMargin=0 rightMargin=0 topMargin=0>
<form id=Form1 method=post runat="server">
<TABLE style="Z-INDEX: 0; WIDTH: 500px; HEIGHT: 456px" id=Table2 border=0 
cellSpacing=0 cellPadding=0 width=648>
  <TR>
    <TD vAlign=top width="1%" align=center><cc1:datagridweb id=grid runat="server" PageSize="15" RowPositionEnabled="False" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False" Width="100%" Height="1px" CssClass="HeaderGrilla">
						...
						</cc1:datagridweb></TD></TR></TABLE></FORM>
	</body>
</HTML>
