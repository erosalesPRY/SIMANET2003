<%@ Page language="c#" Codebehind="AdministrarHistorialExamenMedico.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionSeguridadIndustrial.AdministrarHistorialExamenMedico" %>
	...
	<body onkeypress="if(event.keyCode==13)return false;" onunload="SubirHistorial();" onload="ObtenerHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" border="0" cellSpacing="0" cellPadding="0" width="100%">
				...
				<TR>
					<TD align="center">
						<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="0" width="1139" style="WIDTH: 1139px">
							<TR>
								<TD style="HEIGHT: 28px" bgColor="#000080" vAlign="middle" align="center">
									<asp:label style="Z-INDEX: 0" id="lblTitulo" runat="server" CssClass="TituloPrincipalBlanco"
										Height="11px" Width="330px">LISTADO EXAMEN MEDICO POR PERSONA</asp:label></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD style="BORDER-TOP: gray 1px solid" vAlign="top" align="right">
									<TABLE id="Table4" border="0" cellSpacing="1" cellPadding="1" width="100%" align="right">
										<TR>
                <TD width="60%"></TD>
                <TD width="20%">
<asp:imagebutton style="Z-INDEX: 0" id=ibtnDetalle runat="server" ImageUrl="../imagenes/bt_Restricciones.gif"></asp:imagebutton></TD>
											<TD width="30%"></TD>
...
<ItemStyle Height="30px" CssClass="ItemGrilla">
</ItemStyle>
...
<asp:BoundColumn DataField="NombreCentroMedico" HeaderText="CENTRO MEDICO">
...
<asp:BoundColumn DataField="NombreTipoEMO" HeaderText="TIPO EMO">
<HeaderStyle Width="5%">
</HeaderStyle>
...
<asp:BoundColumn DataField="NombreAptitud" HeaderText="APTITUD">
<HeaderStyle Width="3%">
</HeaderStyle>
...
<asp:BoundColumn DataField="NombreToxicologico" HeaderText="TOXICOLOGICO">
<HeaderStyle Width="3%">
</HeaderStyle>
