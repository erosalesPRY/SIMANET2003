...
function editor_action(button_id) {
  ...
  // fgColor and bgColor
    ...
    //var newcolor = showModalDialog(_editor_url + "popups/select color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
    var newcolor = showModalDialog(_editor_url + "popups/SeleccionarColor.aspx", oldcolor, "dialogHeight:190px;dialogWidth:200px;resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "popups/SeleccionarImagen.aspx", editdoc, "dialogHeight:200px;dialogWidth:430px;resizable: no; help: no; status: no; scroll: no; ");
    }
    ...
    // insert table
      ...
      showModalDialog(_editor_url + "popups/InsertarTabla.aspx?"+objname,window,"dialogHeight:180px;dialogWidth:430px;resizable: yes; help: no; status: no; scroll: no; ");
