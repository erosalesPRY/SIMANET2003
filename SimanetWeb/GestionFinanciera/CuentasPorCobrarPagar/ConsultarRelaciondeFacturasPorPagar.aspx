...
<%@ Page language="c#" Codebehind="ConsultarRelaciondeFacturasPorPagar.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.CuentasPorCobrarPagar.ConsultarRelaciondeFacturasPorPagar" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ConsultarRelaciondeFacturasPorPagar</title>
						...
						<DIV align="center">
							<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="745" align="center" border="0">
								<TR>
									...
									<TD>
										<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD width="2%"><asp:imagebutton id="ibtnFiltrar" runat="server" ImageUrl="../../imagenes/filtrar.gif" CausesValidation="False"></asp:imagebutton></TD>
												...
												<TD style="WIDTH: 1px" align="left" width="1"><asp:label id="Label2" runat="server" CssClass="normaldetalle" Width="51px" Font-Bold="True"> Buscar :</asp:label></TD>
								...
								<TR>
									...
									<TD align="center"><cc1:datagridweb id="grid" runat="server" Width="760px" PageSize="15" AllowPaging="True" AllowSorting="True"
											...
											<Columns>
												...
												<asp:BoundColumn Visible="False" DataField="CantFacturas" HeaderText="CANT">
													<HeaderStyle Width="2%"></HeaderStyle>
													<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoPorPagar" SortExpression="MontoPorPagar" HeaderText="FACTURAS&lt;BR&gt;POR PAGAR">
													<HeaderStyle Width="11.16%"></HeaderStyle>
												...
												<asp:BoundColumn DataField="MontoOCLocalporRecibir" SortExpression="MontoOCLocalporRecibir" HeaderText="FACTURAS&lt;BR&gt;POR RECIBIR&lt;BR&gt;O/C">
													<HeaderStyle Width="11.16%"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoOSLocalporRecibir" SortExpression="MontoOSLocalporRecibir" HeaderText="FACTURAS&lt;BR&gt;POR RECIBIR&lt;BR&gt; O/S">
													<HeaderStyle Width="11.16%"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoOCExteriorpoPagar" SortExpression="MontoOCExteriorpoPagar" HeaderText="FACTURAS&lt;BR&gt;POR PAGAR&lt;BR&gt;MERC EXT.">
													<HeaderStyle Width="11.16%"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoOCExteriorporRecibir" SortExpression="MontoOCExteriorporRecibir"
													HeaderText="FACTURAS&lt;BR&gt;POR RECIBIR&lt;BR&gt;MERC. EXT.">
													<HeaderStyle Width="11.16%"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoTotalporPagar" SortExpression="MontoTotalporPagar" HeaderText="TOTAL">
													<HeaderStyle Width="11.16%"></HeaderStyle>
													<ItemStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Right" VerticalAlign="Middle"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="MontoLetrasxPagar" SortExpression="MontoLetrasxPagar" HeaderText="MONTO&lt;BR&gt;LETRA">
								...
								<TR>
									<TD></TD>
									<TD>
										<TABLE id="Table4" style="DISPLAY: none; WIDTH: 256px; HEIGHT: 34px" cellSpacing="1" cellPadding="1"
											width="256" align="center" border="1">
											<TR class="ItemGrilla">
												...
												<TD align="left"><asp:button id="btnActualizar" runat="server" Width="66px" Text="Actualizar"></asp:button></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
