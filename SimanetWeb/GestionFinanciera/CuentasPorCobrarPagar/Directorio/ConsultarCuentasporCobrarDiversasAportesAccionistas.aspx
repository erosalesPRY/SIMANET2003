...
<%@ Page language="c#" Codebehind="ConsultarCuentasporCobrarDiversasAportesAccionistas.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.CuentasPorCobrarPagar.Directorio.ConsultarCuentasporCobrarDiversasAportesAccionistas" %>
				...
				<TR>
					<TD align="center" vAlign="top" width="100%">
						<TABLE id="Table6" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<TR id="id3">
								<TD class="Commands" style="HEIGHT: 20px" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Financiera > Consultar Cuentas por Cobrar y Pagar ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Cuentas por Cobrar Diversas - Aportes de Accionistas</asp:label></TD>
							</TR>
							<TR>
										...
										<TR>
											<TD align="left" colSpan="3">
												<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
													...
													<TR id="id4">
														<TD style="WIDTH: 246px" bgColor="#f0f0f0">
