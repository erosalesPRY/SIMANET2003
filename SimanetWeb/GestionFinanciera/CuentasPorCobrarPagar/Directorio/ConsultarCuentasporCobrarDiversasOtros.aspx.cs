...
{
	/// <summary>
	/// Summary description for ConsultarCuentasporCobrarDiversasOtros.
	/// </summary>
	public class ConsultarCuentasporCobrarDiversasOtros : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		const string URLDETALLEXCEL="ExportarDetalleExcelCtasCobrarDiversasOtros.aspx";
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.LlenarGrilla implementation
		}
		...
		private DataTable ObtenerDatos()
		{
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasOtrosAlCierre(
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasOtros(
					Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCENTROOPERATIVO]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCUENTAPORCOBRARPAGAR]),
					Convert.ToInt32(Page.Request.Params[KEYQIDSUBCUENTAPORCOBRARPAGAR]));
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.LlenarGrillaOrdenamiento implementation
		}
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasOtros.ValidarFiltros implementation
			return false;
		}
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text = Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos(),
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.RazonSocial,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.Ruc,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.Fecha,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.Referencia,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.Importe,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasOtros.Saldo);
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{				
				...
				string Parametros  = KEYQIDCENTROOPERATIVO  + Utilitario.Constantes.SIGNOIGUAL +  Page.Request.Params[KEYQIDCENTROOPERATIVO].ToString()
					...
					+ Utilitario.Constantes.SIGNOAMPERSON
					+ KEYQIDTIPOCONSULTA + Utilitario.Constantes.SIGNOIGUAL +  "2"
					+ Utilitario.Constantes.SIGNOAMPERSON
