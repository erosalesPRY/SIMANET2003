...
namespace SIMA.SimaNetWeb.GestionFinanciera.CuentasPorCobrarPagar.Directorio
{
	...
	/// </summary>
	public class ConsultarCuentasPorCobrarPagar: System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		//Paginas
		const string URLDETALLE = "ConsultarSubCuentasPorCobrarPagar.aspx?";
		const string URLDETALLERUBROJUDICIAL = "../ConsultarDetalleCuentasPorCobrarJudiciales.aspx?";
		const string URLOTRASCUENTAS = "ConsultarOtrasCuentasPorPagar.aspx?";
		...
		const int RUBROJUDICIAL = 3;
		const int RUBROOTRASCUENTASPORPAGAR = 5;
		const int RUBROPORPROVISIONAR= 6;
		const int RUBROPROVISIONADAS = 7;

		const int JUDICIALCENTROOPERATIVO= 0;
		const int JUDICIALID2 = 10;
		...
		{
			this.lblTipoCuenta.Text= Page.Request.Params[KEYQDESCRIPCION].ToString();
			...
			{
				dtCuentasPorPagar = oCCuentasPorCobrarPagar.ConsultarCuentasPorCobrarPagarPorTipoCuentaAlCierre(
					Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]));
			}
			else
			{
				dtCuentasPorPagar = oCCuentasPorCobrarPagar.ConsultarCuentasPorCobrarPagarPorTipoCuenta(
					Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]));
			}
		/*DataTable dtCuentasPorPagar = 
				oCCuentasPorCobrarPagar.ConsultarCuentasPorCobrarPagarPorTipoCuenta(
				Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]),
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				if (Convert.ToInt32(dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()])==RUBROJUDICIAL ||
					Convert.ToInt32(dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()])==RUBROPORPROVISIONAR ||
					Convert.ToInt32(dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()])==RUBROPROVISIONADAS)
				{
					int id;
					int prov=0;
					id = Convert.ToInt32(dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()]);
					if (id == 6)
					{
						id = 3;
						prov = 1;
					}
					this.MostrarURLDetalle(e,1,2,id, prov);
					
//					e.Item.Cells[1].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
//						Helper.MostrarVentana(URLDETALLERUBROJUDICIAL,
//						PERIODO + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[PERIODO] + 
//						Utilitario.Constantes.SIGNOAMPERSON  + 
//						MES + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[MES] + 
//						Utilitario.Constantes.SIGNOAMPERSON +
...
//						dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()].ToString() +  
...
//						Utilitario.Constantes.SIGNOAMPERSON +
//						KEYQIDCENTROOPERATIVO + Utilitario.Constantes.SIGNOIGUAL + "2"+
//						Utilitario.Constantes.SIGNOAMPERSON +
//						KEYQID2 + Utilitario.Constantes.SIGNOIGUAL + JUDICIALID2 +
...
//					e.Item.Cells[1].ForeColor= System.Drawing.Color.Blue;
					...
					e.Item.Cells[2].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
						...
						Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYQFLAGDIRECTORIO] +  
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQIDCENTROOPERATIVO + Utilitario.Constantes.SIGNOIGUAL + "3"+
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQID2 + Utilitario.Constantes.SIGNOIGUAL + JUDICIALID2 +
						Utilitario.Constantes.SIGNOAMPERSON + Utilitario.Constantes.KEYMODOPAGINA +  
						Utilitario.Constantes.SIGNOIGUAL + Enumerados.ModoPagina.C.ToString())+
					...
					e.Item.Cells[3].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
						...
						Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYQFLAGDIRECTORIO] +  
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQIDCENTROOPERATIVO + Utilitario.Constantes.SIGNOIGUAL + "1"+
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQID2 + Utilitario.Constantes.SIGNOIGUAL + JUDICIALID2 +
						Utilitario.Constantes.SIGNOAMPERSON + Utilitario.Constantes.KEYMODOPAGINA +  
						Utilitario.Constantes.SIGNOIGUAL + Enumerados.ModoPagina.C.ToString())+
					...
					e.Item.Cells[4].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
						...
						Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYQFLAGDIRECTORIO] +  
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQIDCENTROOPERATIVO + Utilitario.Constantes.SIGNOIGUAL + "4"+
						Utilitario.Constantes.SIGNOAMPERSON +
						KEYQID2 + Utilitario.Constantes.SIGNOIGUAL + JUDICIALID2 +
						Utilitario.Constantes.SIGNOAMPERSON + Utilitario.Constantes.KEYMODOPAGINA +  
						Utilitario.Constantes.SIGNOIGUAL + Enumerados.ModoPagina.C.ToString())+
				...
				else if (Convert.ToInt32(dr[Enumerados.FINColumnaResumenCuentasPorPagar.Id.ToString()])==RUBROOTRASCUENTASPORPAGAR)
				{
					e.Item.Cells[0].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
						Helper.MostrarVentana(URLOTRASCUENTAS,
						PERIODO + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[PERIODO] + 
						Utilitario.Constantes.SIGNOAMPERSON  + 
						MES + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[MES] + 
						Utilitario.Constantes.SIGNOAMPERSON +
		...
		private void MostrarURLDetalle(System.Web.UI.WebControls.DataGridItemEventArgs e, int NroColumna, int co, int id, int prov)
		{
			DataRowView drv = (DataRowView)e.Item.DataItem;
			DataRow dr = drv.Row;
			e.Item.Cells[NroColumna].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,
				Helper.MostrarVentana(URLDETALLERUBROJUDICIAL,
				PERIODO + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[PERIODO] + 
				Utilitario.Constantes.SIGNOAMPERSON  + 
				MES + Utilitario.Constantes.SIGNOIGUAL + Page.Request.Params[MES] + 
				...
				Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYQFLAGDIRECTORIO] +  
				Utilitario.Constantes.SIGNOAMPERSON +
				KEYQIDCENTROOPERATIVO + Utilitario.Constantes.SIGNOIGUAL + co.ToString()+
				Utilitario.Constantes.SIGNOAMPERSON +
				KEYQID2 + Utilitario.Constantes.SIGNOIGUAL + JUDICIALID2 +
				Utilitario.Constantes.SIGNOAMPERSON +
				KEYQPORPROVISIONAR + Utilitario.Constantes.SIGNOIGUAL + prov.ToString() +
				Utilitario.Constantes.SIGNOAMPERSON + Utilitario.Constantes.KEYMODOPAGINA +  
				Utilitario.Constantes.SIGNOIGUAL + Enumerados.ModoPagina.C.ToString())+
				Utilitario.Constantes.SIGNOPUNTOYCOMA + Utilitario.Constantes.POPUPDEESPERA +
				Utilitario.Constantes.SIGNOPUNTOYCOMA + 
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			...
			ltlMensaje.Text= Utilitario.Helper.ElaborarFiltro(this,dtCuentasPorPagar,"../../../Filtros.aspx"
				,"*" + Enumerados.FINColumnaResumenCuentasPorPagar.Descripcion.ToString()+";Rubro");
		}
