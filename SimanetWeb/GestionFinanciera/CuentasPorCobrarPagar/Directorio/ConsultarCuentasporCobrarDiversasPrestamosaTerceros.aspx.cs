...
{
	/// <summary>
	/// Summary description for ConsultarCuentasporCobrarDiversasPrestamosaTerceros.
	/// </summary>
	public class ConsultarCuentasporCobrarDiversasPrestamosaTerceros : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.LlenarGrillaOrdenamiento implementation
		}
		...
		private DataTable ObtenerDatos()
		{
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasPrestamosaTercerosAlCierre(
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasPrestamosaTerceros(
					Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCENTROOPERATIVO]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCUENTAPORCOBRARPAGAR]),
					Convert.ToInt32(Page.Request.Params[KEYQIDSUBCUENTAPORCOBRARPAGAR]));
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasPrestamosaTerceros.ValidarFiltros implementation
			return false;
		}
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text = Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos(),
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.RazonSocial,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.Fecha,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.Importe,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.Amortizado,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.Saldo,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasPrestamosaTerceros.Fecha);
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{				
				...
				string Parametros  = KEYQIDCENTROOPERATIVO  + Utilitario.Constantes.SIGNOIGUAL +  Page.Request.Params[KEYQIDCENTROOPERATIVO].ToString()
					...
					+ Utilitario.Constantes.SIGNOAMPERSON
					+ KEYQIDTIPOCONSULTA + Utilitario.Constantes.SIGNOIGUAL +  "3"
					+ Utilitario.Constantes.SIGNOAMPERSON
