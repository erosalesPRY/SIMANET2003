...
{
	/// <summary>
	/// Summary description for ConsultarCuentasporCobrarDiversasReclamosaTerceros.
	/// </summary>
	public class ConsultarCuentasporCobrarDiversasReclamosaTerceros : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		private DataTable ObtenerDatos()
		{
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasReclamosaTercerosAlCierre(
			...
			{
				return ((CCuentasPorCobrarPagar) new CCuentasPorCobrarPagar()).ConsultarCuentasDiversasReclamosaTerceros(
					Convert.ToInt32(Page.Request.Params[KEYQIDTIPOCUENTA]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCENTROOPERATIVO]),
					Convert.ToInt32(Page.Request.Params[KEYQIDCUENTAPORCOBRARPAGAR]),
					Convert.ToInt32(Page.Request.Params[KEYQIDSUBCUENTAPORCOBRARPAGAR]));
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.LlenarGrilla implementation
		}

		public void LlenarGrillaOrdenamiento(string columnaOrdenar)
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.LlenarGrillaOrdenamiento implementation
		}
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.LlenarDatos implementation
		}
		...
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add ConsultarCuentasporCobrarDiversasReclamosaTerceros.ValidarFiltros implementation
			return false;
		}
		...
		private void ibtnFiltrar_Click(object sender, System.Web.UI.ImageClickEventArgs e)
		{
			ltlMensaje.Text = Utilitario.Helper.ElaborarFiltro(this.ObtenerDatos(),
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Empresa,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Ruc,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Fecha,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Importe,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Amortizado,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Saldo,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Concepto,
				Utilitario.Enumerados.FINColumnaCuentaporCobrarDiversasReclamosaTerceros.Observaciones);
		}
