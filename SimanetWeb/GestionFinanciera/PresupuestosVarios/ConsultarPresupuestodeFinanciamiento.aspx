<%@ Page language="c#" Codebehind="ConsultarPresupuestodeFinanciamiento.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.PresupuestoVarios.ConsultarPresupuestodeFinanciamiento" %>
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD vAlign="top" align="center" width="100%">
						<TABLE class="normal" id="Table1" cellSpacing="0" cellPadding="0" width="491" border="0">
							<TR>
								<TD align="center" width="100%" colSpan="3">
									<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TR bgColor="#f0f0f0">
											<TD style="WIDTH: 132px">
												<asp:label id="Label3" runat="server" CssClass="TextoBlanco" Width="144px" ForeColor="Navy"
										...
										<TR bgColor="#f0f0f0">
											<TD style="WIDTH: 132px" colSpan="2">
												<TABLE id="Table3" style="WIDTH: 200px; HEIGHT: 16px" cellSpacing="1" cellPadding="1" width="200"
													align="left" border="0">
													<TR>
														<TD style="WIDTH: 46px">
										...
										<TR bgColor="#f0f0f0">
											<TD style="WIDTH: 132px">
												<asp:label id="Label6" runat="server" CssClass="TextoBlanco" Width="80%" ForeColor="Navy" Font-Bold="True">TIPO :</asp:label></TD>
											<TD>
												<asp:dropdownlist id="ddldTipo" runat="server" CssClass="combos" Width="355px" AutoPostBack="True"></asp:dropdownlist></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							...
							<TR>
								<TD align="left" width="100%" colSpan="3"><IMG id="ibtnAtras" onclick="HistorialIrAtras();" alt="" src="../../imagenes/atras.gif"><INPUT id="hGridPagina" style="WIDTH: 32px; HEIGHT: 22px" type="hidden" size="1" value="0"
										...
										runat="server"><INPUT id="hTrama" style="WIDTH: 64px; HEIGHT: 22px" type="hidden" size="5" name="hTrama"
										runat="server"></TD>
							</TR>
						</TABLE>
					</TD>
