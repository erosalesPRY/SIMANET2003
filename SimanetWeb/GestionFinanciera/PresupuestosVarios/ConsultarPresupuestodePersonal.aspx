...
<%@ Page language="c#" Codebehind="ConsultarPresupuestodePersonal.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.PresupuestoVarios.ConsultarPresupuestodePersonal" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" rightMargin="0"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD class="RutaPaginaActual" width="100%" colSpan="3"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestión Financiera> Presupuesto > Gastos de Personal ></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Estados Financieros</asp:label></TD>
				</TR>
				<TR>
								...
								<TD align="center" width="100%" colSpan="3">
									...
									<ITEMSTYLE CssClass="ItemGrilla"></ITEMSTYLE><HEADERSTYLE CssClass="HeaderGrilla"></HEADERSTYLE><FOOTERSTYLE CssClass="FooterGrilla"></FOOTERSTYLE><COLUMNS><ASP:TEMPLATECOLUMN HeaderText="CONCEPTO"><HEADERSTYLE Width="75%" Font-Bold="True"></HEADERSTYLE>
										...
										<Columns>
											...
											<asp:BoundColumn HeaderText="PROYECTADO">
											...
											<asp:BoundColumn DataField="TotalPPto" SortExpression="TotalPPto" HeaderText="PRESUPUESTO">
												<HeaderStyle HorizontalAlign="Center" Width="16%" VerticalAlign="Middle"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="EjecutadoAlMes" SortExpression="EjecutadoAlMes" HeaderText="EJECUCION">
												<HeaderStyle Width="16%" VerticalAlign="Middle"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="SaldoAlMes" SortExpression="SaldoAlMes" HeaderText="SALDO">
												<HeaderStyle Width="16%" VerticalAlign="Middle"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
											</asp:BoundColumn>
										</Columns>
