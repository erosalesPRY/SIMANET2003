...
{
	/// <summary>
	/// Summary description for EstadosFinancierosProyectados.
	/// </summary>
	public class EstadosFinancierosProyectados : System.Web.UI.Page,IPaginaBase
	{
		#region Constantes
		...
		const string URLIMPRESION = "PopupImpresionEstadosFinancierosProyectados.aspx";

		//Datos DataGrid and DataTable
		...
		public void LlenarGrilla()
		{
			...
			DataTable dtEstadoFinanciero = oCEstadoFinancieroPresupuestal.ConsultarEstadosFinancierosPresupuestalesProyeccionporEmpresa
			...
			if(dtEstadoFinanciero!=null)
			{
				...
				oCImpresion.GuardarDataImprimirExportar(dtEstadoFinanciero,				
					...
					Convert.ToString(Page.Request.Params[NOMBRECENTRO]),	//KEYQIDACUMULADO
					Convert.ToString(Page.Request.Params[KEYQIDFECHA]),
					Convert.ToString(Page.Request.Params[KEYQIDNOMBREMES]),	//KEYQIDNOMBREMES
		...
		{
			// TODO:  Add EstadosFinancierosProyectados.LlenarGrillaOrdenamiento implementation
		}

		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			// TODO:  Add EstadosFinancierosProyectados.LlenarGrillaOrdenamientoPaginacion implementation
		}

		public void LlenarCombos()
		{
			// TODO:  Add EstadosFinancierosProyectados.LlenarCombos implementation
		}

		public void LlenarDatos()
		{
			this.lblPagina.Text = Page.Request.Params[KEYQIDNOMBREFORMATO].ToString().ToUpper();
			lblEmpresa.InnerText= Page.Request.Params[NOMBRECENTRO].ToString().ToUpper();

			this.lblPeriodo.Text = Convert.ToDateTime(Page.Request.Params[KEYQIDFECHA]).Year.ToString();
			this.lblMes.Text = Page.Request.Params[KEYQIDNOMBREMES].ToString();
			// TODO:  Add EstadosFinancierosProyectados.LlenarDatos implementation
		}

		public void LlenarJScript()
		{
			// TODO:  Add EstadosFinancierosProyectados.LlenarJScript implementation
		}

		public void RegistrarJScript()
		{
			// TODO:  Add EstadosFinancierosProyectados.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			ltlMensaje.Text = Helper.PopupImpresion(URLIMPRESION,650,700,false,false,false,true,true);
			//ltlMensaje.Text =Helper.PopupImpresionSinPostBack(URLIMPRESION,650,700,false,false,false,true,true);
		}

		public void Exportar()
		{
			// TODO:  Add EstadosFinancierosProyectados.Exportar implementation
		}
		...
		{
			// TODO:  Add EstadosFinancierosProyectados.ValidarFiltros implementation
			return false;
		}
		...
		private void ItemDataBound(DataTable dt)
		{
			...
			foreach(DataRow dr in dt.Rows)
			{
				...
				Helper.ConfiguraNodosTreeview(tblrow,3,nroFila,Convert.ToInt32(Page.Request.Params[KEYQIDNIVELEXPANDE]),dr,String.Empty);
		...
		private void BuscarValoresEnArray()
		{
