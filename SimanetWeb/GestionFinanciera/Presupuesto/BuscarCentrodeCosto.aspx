...
<%@ Page language="c#" Codebehind="BuscarCentrodeCosto.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.Presupuesto.BuscarCentrodeCosto" %>
...
<HTML>
  <HEAD>
		...
		<script>
			function ConsultarCentrosdeCostos(){
			...
			function CargarDatos(){
					...
					oDataTable = (new Controladora.Presupuesto.CRequerimientos()).CosultarCentrodeCostoPorGrupo(oPagina.Request.Params[KEYQIDGRUPOCC],objTxt.value);
			...
			function ItemDataBound(sender,e){
				...
				e.Item.cells(1).innerText=dr.Item("NROCC") + " " + dr.Item("NOMBRE");
				e.Item.cells(1).setAttribute("IDCENTROCOSTO",dr.Item("IDCENTROCOSTO"));
			...
			function SeleccionarItem(e){
				...
				ArrDatosRemotos.Adicionar(e.cells(1).getAttribute("IDCENTROCOSTO"));
	...
	<body onload="CargarDatos();" oncontextmenu="return false" onkeydown="if (event.keyCode==13 || event.keyCode==9)return false"
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" cellSpacing="1" cellPadding="1" width="100%" border="0">
				<TR bgcolor="#f5f5f5">
					<TD>
						<asp:label id="Label3" runat="server" CssClass="TextoNegroNegrita" Width="288px"> RELACION DECENTROS DE COSTO POR GRUPO:</asp:label></TD>
				</TR>
				<TR bgcolor="#f5f5f5">
					<TD>
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" align="left" border="0">
							<TR>
								<TD style="WIDTH: 63px"><asp:label id="Label1" runat="server" CssClass="TextoNegroNegrita" Width="56px">GRUPO :</asp:label></TD>
								<TD style="WIDTH: 141px">
									<asp:label id="lblGrupoCC" runat="server" Width="176px" CssClass="TextoNegroNegrita">GRUPO CENTRO COSTO:</asp:label></TD>
						...
						<DIV style="WIDTH: 100%; HEIGHT: 98.13%" ms_positioning="FlowLayout" class="scroll">
							<cc1:datagridweb id="grid" runat="server" Width="100%" PageSize="17" AutoGenerateColumns="False"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="Nombre" HeaderText="CENTROS DE COSTO">
