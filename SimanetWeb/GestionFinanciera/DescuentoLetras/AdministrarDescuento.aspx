<%@ Page language="c#" Codebehind="AdministrarDescuento.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.DescuentoLetras.AdministrarDescuento" %>
	...
	<body oncontextmenu="return false" bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="100%" align="right" border="0">
				...
				<TR>
					<TD class="RutaPaginaActual" vAlign="top" width="100%"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestión Financiera></asp:label><asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Administrar Descuento de Letras</asp:label></TD>
				</TR>
				<TR>
								...
								<TD align="center" width="100%" colSpan="3">
									<TABLE style="HEIGHT: 25px" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR bgColor="#f0f0f0">
											...
											<TD style="WIDTH: 115px"><IMG style="WIDTH: 329px; HEIGHT: 8px" height="8" src="../imagenes/spacer.gif" width="329"></TD>
											<TD style="WIDTH: 188px">
												<asp:imagebutton id="ibtnAgregar" runat="server" ImageUrl="../../imagenes/bt_agregar.gif" CausesValidation="False"
													DESIGNTIMEDRAGDROP="41"></asp:imagebutton></TD>
											<TD style="WIDTH: 187px"><asp:imagebutton id="ibtnLetrasenDescuento" runat="server" ImageUrl="../../imagenes/LetrasEnDescuento.GIF"
														...
														<TR>
															...
															<TD style="BORDER-LEFT: #cccccc 1px solid" align="center" width="20%">
																<asp:Label id="Label3" runat="server" CssClass="headergrilla" ToolTip="Interés Cobrado por el Banco"
																	DESIGNTIMEDRAGDROP="88" BorderStyle="None">INTERES/<br>GASTO</asp:Label></TD>
															<TD style="BORDER-LEFT: #cccccc 1px solid" align="center" width="20%">
						...
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="768" border="0">
							<TR>
								<TD align="left"><IMG id="ibtnAtras" onclick="HistorialIrAtras();" alt="" src="../../imagenes/atras.gif"><INPUT id="hGridPaginaSort" style="WIDTH: 32px; HEIGHT: 22px" type="hidden" size="1" name="hGridPaginaSort"
										...
										runat="server"><INPUT id="hidMoneda" style="WIDTH: 40px; HEIGHT: 22px" type="hidden" size="1" runat="server"></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
