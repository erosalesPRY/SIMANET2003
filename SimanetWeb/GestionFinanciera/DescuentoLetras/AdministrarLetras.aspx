<%@ Page language="c#" Codebehind="AdministrarLetras.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.DescuentoLetras.AdministrarLetras" %>
	...
	<HEAD>
		...
		<script>
			function RenovarLetras(){
				...
				var oVentana = new SIMA.Utilitario.Helper.Window();
				with(SIMA.Utilitario.Constantes.General.Caracter){
					var URLPAGINA = SIMA.Utilitario.Helper.General.ObtenerPathApp() + "/GestionFinanciera/DescuentoLetras/AdministrarLetrasRenovaciones.aspx" + signoInterrogacion
									+ KEYIDDOCLET + SignoIgual + $O('hidLetra').value;
					oVentana.AbrirAchivo(URLPAGINA);
				}
			}
		</script>
	</HEAD>
