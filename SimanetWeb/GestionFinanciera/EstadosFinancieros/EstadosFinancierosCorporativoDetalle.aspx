<%@ Page language="c#" Codebehind="EstadosFinancierosCorporativoDetalle.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.EstadosFinancieros.EstadosFinancierosCorporativoDetalle" %>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" onload="ObtenerHistorial();" rightMargin="0"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
								...
								<TD align="center" width="100%" colSpan="3">
									<TABLE id="Table3" style="HEIGHT: 22px" cellSpacing="0" cellPadding="0" width="770" border="0">
										<TR bgColor="#f0f0f0">
											...
											<TD width="100%">&nbsp;
												<asp:label id="Label1" runat="server" CssClass="TituloPrincipalBlanco" Width="80%" Font-Bold="True" ForeColor="Navy">EN MILES DE NUEVOS SOLES</asp:label>
											</TD>
											<TD vAlign="bottom">&nbsp;</TD>
											<TD></TD>
				...
				<TR>
					<TD align="center" colSpan="3">
						<TABLE id="Table17" cellSpacing="1" cellPadding="5" width="770" border="0">
							<TR>
