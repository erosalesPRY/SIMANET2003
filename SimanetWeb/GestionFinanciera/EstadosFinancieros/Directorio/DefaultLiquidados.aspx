<%@ Page language="c#" Codebehind="DefaultLiquidados.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.EstadosFinancieros.Directorio.DefaultLiquidados" %>
	...
	<HEAD>
		...
		<script>
			function CargarTabs()
			{
				...
				var KEYQFLAGDIRECTORIO= "FlagDirectorio";				
				var pidReporte =1;
				...
				urlPaginaConsultarEF = SIMA.Utilitario.Helper.General.ObtenerPathApp() + "/GestionFinanciera/ProyectosPorProvisionarLiquidar/ConsultarProyectoPorLiquidarProvisionar.aspx?";
					...
					with(SIMA.Utilitario.Constantes.General.Caracter)
					{
						Parametros = KEYQIDFORMATO + SignoIgual.toString() + oPagina.Request.Params[KEYQIDFORMATO]
									...
									+ signoAmperson.toString()
									+ KEYQFLAGDIRECTORIO + SignoIgual.toString() + oPagina.Request.Params[KEYQFLAGDIRECTORIO]
									+ signoAmperson.toString()								
