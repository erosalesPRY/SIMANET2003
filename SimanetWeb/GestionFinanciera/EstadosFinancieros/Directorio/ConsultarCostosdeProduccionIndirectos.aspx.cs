...
{
	/// <summary>
	/// Summary description for ConsultarCostosdeProduccionIndirectos.
	/// </summary>
	public class ConsultarCostosdeProduccionIndirectos : System.Web.UI.Page, IPaginaBase
	{
		#region Controles
		...
		public DataTable ObtenerDatos()
		{
			...
			return oCEstadosFinancieros.ConsultarCostoProduccionIndirecto(Convert.ToInt32(Page.Request.Params[KEYIDCENTRO]),Page.Request.QueryString[KEYCOD_DIV].ToString(), Page.Request.QueryString[KEYNRO_OTS].ToString(),
		...
		public void Totalizar (DataView dwTotales)
		{
			if (dwTotales != null)
			{
				double [] aArreglo = Helper.TotalizarDataView(dwTotales,"mob");
				Totmob = aArreglo[0];

				aArreglo = Helper.TotalizarDataView(dwTotales,"mat");
				Totmat = aArreglo[0];

				aArreglo = Helper.TotalizarDataView(dwTotales,"ser");
				Totser = aArreglo[0];
		...
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.LlenarGrillaOrdenamientoPaginacion implementation
		}
		...
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.LlenarJScript implementation
		}

		public void RegistrarJScript()
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.Exportar implementation
		}

		public void ConfigurarAccesoControles()
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.ConfigurarAccesoControles implementation
		}

		public bool ValidarFiltros()
		{
			// TODO:  Add ConsultarCostosdeProduccionIndirectos.ValidarFiltros implementation
			return false;
		}
...
//
				if(Convert.ToInt32(Session[Utilitario.Constantes.KEYQOBSERVACION])==1)
				{
					...
					string parametros =KEYQIDFORMATO + Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYQIDFORMATO].ToString() +
						...
						+ Utilitario.Constantes.SIGNOAMPERSON 	
						+ KEYQOT + Utilitario.Constantes.SIGNOIGUAL + Page.Request.QueryString[KEYNRO_OTS].ToString()
						+ Utilitario.Constantes.SIGNOAMPERSON 	
			...
			{
				e.Item.Cells[3].Text = Totmob.ToString(Constantes.FORMATODECIMAL4);
				e.Item.Cells[4].Text = Totmat.ToString(Constantes.FORMATODECIMAL4);
				e.Item.Cells[5].Text = Totser.ToString(Constantes.FORMATODECIMAL4);
				e.Item.Cells[6].Text = Tottotal.ToString(Constantes.FORMATODECIMAL4);
			}
		}
		...
		private void grid_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
		{
			...
			this.LlenarGrillaOrdenamiento(Session["orden"].ToString());
		}
