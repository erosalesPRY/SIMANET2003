<%@ Page language="c#" Codebehind="ConsultarCostosdeProduccionIndirectos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.EstadosFinancieros.Directorio.ConsultarCostosdeProduccionIndirectos" %>
						...
						<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR bgColor="#f0f0f0">
								<TD align="left">
									<TABLE id="Table0" cellSpacing="1" cellPadding="1" width="100%" align="left" border="0">
										...
										<TR>
											<TD colSpan="5">
												<asp:Label id="lblDesCostoProduccion" runat="server" ForeColor="Navy" CssClass="TituloPrincipalBlanco">COSTO DE PRODUCCION INDIRECTO</asp:Label></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							<TR>
								<TD align="center"><cc1:datagridweb id="grid" runat="server" Width="50%" RowHighlightColor="#E0E0E0" AutoGenerateColumns="False"
										ShowFooter="True" CssClass="HeaderGrilla" AllowSorting="True">
										...
										<Columns>
											...
											<asp:BoundColumn DataField="ano_prc" SortExpression="ano_prc" HeaderText="A&#209;O">
												<HeaderStyle Width="15%" VerticalAlign="Middle"></HeaderStyle>
												<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="mes_prc" SortExpression="mes_prc" HeaderText="MES">
												<HeaderStyle Width="15%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<FooterStyle HorizontalAlign="Right"></FooterStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="mob" SortExpression="mob" HeaderText="MANO OBRA" DataFormatString="{0:# ### ### ##0.00}">
												<HeaderStyle Width="15%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right"></ItemStyle>
												<FooterStyle HorizontalAlign="Right"></FooterStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="mat" SortExpression="mat" HeaderText="MATERIALES" DataFormatString="{0:# ### ### ##0.00}">
												<HeaderStyle Width="15%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right"></ItemStyle>
												<FooterStyle HorizontalAlign="Right"></FooterStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="ser" SortExpression="ser" HeaderText="SERVICIOS" DataFormatString="{0:# ### ### ##0.00}">
												<HeaderStyle Width="15%"></HeaderStyle>
												<ItemStyle HorizontalAlign="Right"></ItemStyle>
												<FooterStyle HorizontalAlign="Right"></FooterStyle>
											</asp:BoundColumn>
