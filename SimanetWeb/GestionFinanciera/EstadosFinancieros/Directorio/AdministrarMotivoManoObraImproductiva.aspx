<%@ Page language="c#" Codebehind="AdministrarMotivoManoObraImproductiva.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionFinanciera.EstadosFinancieros.Directorio.AdministrarMotivoManoObraImproductiva" %>
							...
							<TR bgColor="#f0f0f0">
								<TD align="left">
									<TABLE id="Table5" cellSpacing="1" cellPadding="1" width="100%" align="left" border="0">
										<TR>
											<TD style="WIDTH: 52px" height="10"></TD>
											<TD style="WIDTH: 36px" height="10"></TD>
											<TD style="WIDTH: 24px" height="10"></TD>
											<TD style="WIDTH: 75px" height="10"></TD>
							...
							<TR>
								<TD><cc1:datagridweb id="grid" runat="server" Width="100%" AllowPaging="True" ShowFooter="True" AutoGenerateColumns="False"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NROPERSONAL" SortExpression="NROPERSONAL" HeaderText="COD">
											...
											<asp:BoundColumn DataField="Horas" SortExpression="Horas" HeaderText="H">
												<HeaderStyle Width="2%"></HeaderStyle>
