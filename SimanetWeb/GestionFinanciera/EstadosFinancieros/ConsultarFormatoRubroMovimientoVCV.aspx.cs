...
namespace SIMA.SimaNetWeb.GestionFinanciera.EstadosFinancieros
{
	...
	/// </summary>
	public class ConsultarFormatoRubroMovimientoVCV : System.Web.UI.Page,IPaginaBase
	{
		#region Constantes
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if(e.Item.ItemType == ListItemType.Header)
			{
				...
				Label ControlSP = (Label)e.Item.Cells[1].FindControl(CONTROLSP);
				varTemp = ControlSP.ClientID.ToString();//Variable utilizada para obtener el nombre del control desde el lado del cliente
				ControlSP.Font.Underline = true;
				ControlSP.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,"MostrarValor(1)," + Utilitario.Constantes.CAMBIARCOLORSELECCIONGRILLAPOPUP);
				...
				ControlSC.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,"MostrarValor(2)," + Utilitario.Constantes.CAMBIARCOLORSELECCIONGRILLAPOPUP);
				...
				ControlSCH.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,"MostrarValor(3)," + Utilitario.Constantes.CAMBIARCOLORSELECCIONGRILLAPOPUP);
				...
				ControlSI.Attributes.Add(Utilitario.Constantes.EVENTOCLICK,"MostrarValor(4)," + Utilitario.Constantes.CAMBIARCOLORSELECCIONGRILLAPOPUP);
				ControlSI.Style.Add(Utilitario.Constantes.CURSOR,Utilitario.Constantes.TIPOCURSORMANO);
			}
			...
			if((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
			{
				...
				DataRow dr = drv.Row;				
					/*TotalPeru*/	
					((Label) e.Item.Cells[1].FindControl(CAMPO7)).Text = Convert.ToDouble(Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCVENTAS]) / Utilitario.Constantes.MILES) + Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCHVENTAS]) / Utilitario.Constantes.MILES)).ToString(Utilitario.Constantes.FORMATODECIMAL5);
					((Label) e.Item.Cells[1].FindControl(CAMPO8)).Text = Convert.ToDouble(Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCCOSTOVENTAS]) / Utilitario.Constantes.MILES) + Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCHCOSTOVENTAS]) / Utilitario.Constantes.MILES)).ToString(Utilitario.Constantes.FORMATODECIMAL5);	
						
					/*TotalCallao*/	
					((Label) e.Item.Cells[1].FindControl(CAMPO1)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCVENTAS]) / Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);
					((Label) e.Item.Cells[1].FindControl(CAMPO2)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCCOSTOVENTAS])/ Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);

					/*TotalChimbote*/	
					((Label) e.Item.Cells[1].FindControl(CAMPO3)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCHVENTAS]) / Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);
					((Label) e.Item.Cells[1].FindControl(CAMPO4)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASCHCOSTOVENTAS])/ Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);

					/*TotalIquitos*/	
					((Label) e.Item.Cells[2].FindControl(CAMPO5)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASIVENTAS]) / Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);
					((Label) e.Item.Cells[2].FindControl(CAMPO6)).Text = Convert.ToDouble(Convert.ToDouble(dr[COLUMNASICOSTOVENTAS])/ Utilitario.Constantes.MILES).ToString(Utilitario.Constantes.FORMATODECIMAL5);
			...
			if(e.Item.ItemType == ListItemType.Footer)
			{
				...
				((Label) e.Item.Cells[1].FindControl(FCAMPO7)).Text = totalSPV.ToString(Utilitario.Constantes.FORMATODECIMAL5);
				((Label) e.Item.Cells[1].FindControl(FCAMPO8)).Text = totalSPC.ToString(Utilitario.Constantes.FORMATODECIMAL5);
					
				((Label) e.Item.Cells[1].FindControl(FCAMPO1)).Text = totalSCV.ToString(Utilitario.Constantes.FORMATODECIMAL5);
				((Label) e.Item.Cells[1].FindControl(FCAMPO2)).Text = totalSCC.ToString(Utilitario.Constantes.FORMATODECIMAL5);

				((Label) e.Item.Cells[1].FindControl(FCAMPO3)).Text = totalSCHV.ToString(Utilitario.Constantes.FORMATODECIMAL5);
				((Label) e.Item.Cells[1].FindControl(FCAMPO4)).Text = totalSCHC.ToString(Utilitario.Constantes.FORMATODECIMAL5);
