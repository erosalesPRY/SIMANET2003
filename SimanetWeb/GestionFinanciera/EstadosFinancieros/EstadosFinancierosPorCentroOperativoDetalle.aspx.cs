...
{
	/// <summary>
	/// Summary description for EstadosFinancierosPorCentroOperativoDetalle.
	/// </summary>
	public class EstadosFinancierosPorCentroOperativoDetalle : System.Web.UI.Page,IPaginaBase
	{
		#region Constantes
		...
		const string NOMBREDATATABLE ="Resumen";
		...
		private DataTable ObtenerDatos(int pNroDig,string pDigCuenta)
		{
			...
			return oCEstadosFinancieros.ConsultarEstadosFinancierosMovimientosCorporativo
		...
		private DataTable CrearTabla()
		{
			...
			DataTable tblResumen = new DataTable(NOMBREDATATABLE); 
			string []NombreCampos = {"CuentaContable","NombreCuenta","PeruPresupuestoAnual","PeruEjecucionRealDelmesAnterior","PeruEjecucionRealDelmesActual","PeruEjecucionRealAcumulado","PeruProyectadoAnual","IquitosPresupuestoAnual","IquitosEjecucionRealDelmesAnterior","IquitosEjecucionRealDelmesActual","IquitosEjecucionRealAcumulado","IquitosProyectadoAnual"};
		...
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.LlenarGrillaOrdenamiento implementation
		}

		public void LlenarGrillaOrdenamientoPaginacion(string columnaOrdenar, int indicePagina)
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.LlenarGrillaOrdenamientoPaginacion implementation
		}

		public void LlenarCombos()
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.LlenarCombos implementation
		}
		...
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.LlenarJScript implementation
		}

		public void RegistrarJScript()
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.RegistrarJScript implementation
		}

		public void Imprimir()
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.Imprimir implementation
		}

		public void Exportar()
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.Exportar implementation
		}
		...
		{
			// TODO:  Add EstadosFinancierosPorCentroOperativoDetalle.ValidarFiltros implementation
			return false;
		}
		...
		private void grid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{	
				...
				string visible = (Convert.ToInt32(Page.Request.Params[KEYQIDFORMATO]) == Utilitario.Constantes.KEYIDFORMATOCUENTASPORCOBRAR || Convert.ToInt32(Page.Request.Params[KEYQIDFORMATO]) == Utilitario.Constantes.KEYIDFORMATOCUENTASPORPAGAR)? Utilitario.Constantes.NONE:Utilitario.Constantes.BLOCK;
			...
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				e.Item.Cells[0].Attributes.Add(Utilitario.Constantes.EVENTOCLICK,Helper.MostrarVentana(URLDETALLE,
					...
					+ Utilitario.Constantes.SIGNOAMPERSON
					+ KEYQDIGCUENTA + Utilitario.Constantes.SIGNOIGUAL + e.Item.Cells[0].Text
					+ Utilitario.Constantes.SIGNOAMPERSON
		...
		private void gridResumen_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if(e.Item.ItemType == ListItemType.Header)
			{
				...
				{
					#region Sima Peru Mes Anterior
					e.Item.Cells[2].Text = Prefijo + TITULOMES + Helper.ObtenerNombreMes(FechaPeriodo.Month-1 ,Utilitario.Enumerados.TipoDatoMes.NombreCompleto).ToUpper();
					e.Item.Cells[2].Font.Size=7;
					#endregion
					#region Sima Iquitos Mes Anterior
					e.Item.Cells[7].Text = Prefijo + TITULOMES + Helper.ObtenerNombreMes(FechaPeriodo.Month-1 ,Utilitario.Enumerados.TipoDatoMes.NombreCompleto).ToUpper();
					e.Item.Cells[7].Font.Size=7;
					#endregion
				}
				//Mes Actual
				#region Sima Peru Mes Actual
				e.Item.Cells[3].Text = Prefijo + TITULOMES + Helper.ObtenerNombreMes(FechaPeriodo.Month,Utilitario.Enumerados.TipoDatoMes.NombreCompleto).ToUpper();
				e.Item.Cells[3].Font.Size=7;
				#endregion
				#region Sima Iquitos Mes Actual
				e.Item.Cells[8].Text = Prefijo + TITULOMES + Helper.ObtenerNombreMes(FechaPeriodo.Month,Utilitario.Enumerados.TipoDatoMes.NombreCompleto).ToUpper();
				e.Item.Cells[8].Font.Size=7;
				#endregion
				#endregion
				...
				//Datos de Presupuesto
				#region Presupuesto Sima Peru
				e.Item.Cells[5].Text = TITULOPTO;
				e.Item.Cells[5].Font.Size=7;
				#endregion

				#region Sima - Iquitos
				e.Item.Cells[10].Text = TITULOPTO;
				e.Item.Cells[10].Font.Size=7;
				#endregion
				#endregion
				...
				#region Columna de Acumulado Sima Peru / Sima Iquitos
				#region Sima Peru
				e.Item.Cells[4].Text = TITULOACUMULADO;
				e.Item.Cells[4].Font.Size=7;
				#endregion
				#region Sima Iquitos
				e.Item.Cells[9].Text = TITULOACUMULADO;
				e.Item.Cells[9].Font.Size=7;
				#endregion
				#endregion
				...
				#region Columnas de Proyeccion Sima Peru / SIma Iquitos
				#region Sima Peru
				e.Item.Cells[6].Text = TITULOPROYECTADO;
				e.Item.Cells[6].Font.Size=7;
				#endregion

				#region Sima Iquitos
				e.Item.Cells[11].Text = TITULOPROYECTADO;
				e.Item.Cells[11].Font.Size=7;
				#endregion
