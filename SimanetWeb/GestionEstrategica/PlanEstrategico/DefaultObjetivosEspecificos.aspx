<%@ Page language="c#" Codebehind="DefaultObjetivosEspecificos.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionEstrategica.PlanEstrategico.DefaultObjetivosEspecificos" %>
	...
	<HEAD>
		...
		<script>
			function CargarTabs()
			{
				...
				urlPagina = SIMA.Utilitario.Helper.General.ObtenerPathApp() + "/GestionEstrategica/PlanEstrategico/ConsultarPlanEstrategicoObjetivosEspecificos.aspx?";
			...
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<TR>
					<TD class="RutaPaginaActual" vAlign="top" width="100%">
						<asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestión Estrategica></asp:label>
						<asp:label id="lblPagina" runat="server" CssClass="RutaPaginaActual"> Consultar Objetivos Especificos</asp:label></TD>
				</TR>
				<TR>
