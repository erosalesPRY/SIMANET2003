<%@ Page language="c#" Codebehind="ConsultarObjetivoGeneralDetalleparaProcesoEstrategico.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionEstrategica.PlanEstrategico.ConsultarObjetivoGeneralDetalleparaProcesoEstrategico" %>
...
<HTML>
  <HEAD>
		<title>ConsultarObjetivoGeneralDetalleparaProcesoEstrategico</title>
		...
		<form id="Form2" method="post" runat="server">
			<P>
				<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						<TD align="center">
							<asp:Label id="lblPlanEstrategico" runat="server" CssClass="TituloPrincipalAzul" Width="100%">PLAN ESTRATEGICO:</asp:Label></TD>
					</TR>
					<TR>
						<TD>
										...
										<TD style="HEIGHT: 3px" bgColor="#f0f0f0">
											<P align="center">
												<TABLE id="Table4" borderColor="#ffffff" cellSpacing="0" cellPadding="1" width="100%" bgColor="#f0f0f0"
													border="2">
													<TR>
														<TD style="WIDTH: 50px" bgColor="#f0f0f0" align=center>
															<asp:Label id="lblCodigoObjGeneral" runat="server" CssClass="normaldetalle" Width="100%"></asp:Label></TD>
														<TD bgColor="#f0f0f0">
