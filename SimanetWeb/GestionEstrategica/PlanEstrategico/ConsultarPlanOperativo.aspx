...
<%@ Page language="c#" Codebehind="ConsultarPlanOperativo.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionEstrategica.PlanEstrategico.ConsultarPlanOperativo" %>
...
<asp:label id=Label2 runat="server" CssClass="HeaderGrilla" Width="210px" Height="26px">Objetivo Específico del plan operativo</asp:label></TD>
<TD>
...
<TD></TD>
<TD>
<asp:label id=lblTotal1 runat="server" CssClass="headerGrilla" Width="50px" Height="20px">Unidad Medida</asp:label></TD>
<TD>
<asp:label id=lblTotal runat="server" CssClass="headerGrilla" Width="50px" Height="25px">Total</asp:label></TD>
<TD>
<asp:label id=lblAno2 runat="server" CssClass="headerGrilla" Width="50px" Height="20px">Al I Trimes.</asp:label></TD>
<TD>
<asp:label id=lblAno3 runat="server" CssClass="headerGrilla" Width="50px" Height="20px">Al II Trimes.</asp:label></TD>
<TD>
<asp:label id=lblAno4 runat="server" CssClass="headerGrilla" Width="50px" Height="20px">Al III Trimes.</asp:label></TD>
<TD>
<asp:label id=lblAno5 runat="server" CssClass="headerGrilla" Width="50px" Height="20px">Al IV Trimes.</asp:label></TD></TR></TABLE>
</HeaderTemplate>
...
<PagerStyle CssClass="PagerGrilla" Wrap="False" Mode="NumericPages">
</PagerStyle>
...
<asp:BoundColumn DataField="Unidad" HeaderText="Total">
...
<asp:BoundColumn DataFormatString="{0:# ### ### ### ##0}">
<HeaderStyle Width="15%">
</HeaderStyle>
...
<asp:BoundColumn DataField="Trimestre1" DataFormatString="{0:# ### ### ### ##0}">
<HeaderStyle Width="15%">
</HeaderStyle>
...
<asp:BoundColumn DataField="Trimestre2" DataFormatString="{0:# ### ### ### ##0}">
<HeaderStyle Width="15%">
</HeaderStyle>
...
<asp:BoundColumn DataField="Trimestre3" DataFormatString="{0:# ### ### ### ##0}">
<HeaderStyle Width="15%">
</HeaderStyle>
...
<asp:BoundColumn DataField="Trimestre4" DataFormatString="{0:# ### ### ### ##0}">
<HeaderStyle Width="15%">
</HeaderStyle>
...
<HeaderStyle Wrap="False" Height="26px" CssClass="HeaderGrilla">
</HeaderStyle>
</cc1:datagridweb>
