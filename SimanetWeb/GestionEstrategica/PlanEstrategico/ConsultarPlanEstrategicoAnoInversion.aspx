<%@ Page language="c#" Codebehind="ConsultarPlanEstrategicoAnoInversion.aspx.cs" AutoEventWireup="false" Inherits="SIMA.SimaNetWeb.GestionEstrategica.PlanEstrategico.ConsultarPlanEstrategicoAnoInversion" %>
...
<HTML>
	<HEAD>
		<title>ConsultarPlanEstrategicoAnoInversion</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onkeydown="if (event.keyCode==13 || event.keyCode==9)return false"
		...
		<form id="Form2" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD class="Commands" style="HEIGHT: 20px"><asp:label id="lblRutaPagina" runat="server" CssClass="RutaPagina">Inicio > Gestion Estratégica > Plan Estratégico >  Consultar Año Inversión ></asp:label></TD>
				</TR>
				<TR>
					<TD>
